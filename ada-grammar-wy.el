...
(defconst ada-grammar-wy--parse-table
   ...
   '((AMPERSAND BAR BOX COLON COLON_EQUAL COMMA DOT DOT_DOT EQUAL EQUAL_GREATER GREATER GREATER_EQUAL GREATER_GREATER LESS LESS_EQUAL LESS_LESS MINUS PLUS SEMICOLON SLASH SLASH_EQUAL STAR STAR_STAR TICK NUMERIC_LITERAL IDENTIFIER STRING_LITERAL CHARACTER_LITERAL ABS ACCEPT ABORT ABSTRACT ACCESS ALIASED ALL AND ARRAY AT BEGIN BODY CASE CONSTANT DECLARE DELAY DELTA DIGITS DO ELSE ELSIF END ENTRY EXCEPTION EXIT FOR FUNCTION GENERIC GOTO IF IN INTERFACE IS LEFT_PAREN LIMITED LOOP MOD NEW NOT NULL OF OR OTHERS OUT OVERRIDING PACKAGE PRAGMA PRIVATE PROCEDURE PROTECTED RAISE RANGE RECORD REM RENAMES REQUEUE RETURN REVERSE RIGHT_PAREN SEPARATE SELECT SOME SUBTYPE SYNCHRONIZED TAGGED TASK TERMINATE THEN TYPE UNTIL USE WHEN WHILE WITH XOR )
     ...
     [((default . error) (SEPARATE .  10) (USE .  11) (LIMITED .  3) (PRIVATE .  8) (WITH .  12) (PRAGMA .  7) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (PACKAGE .  6) (GENERIC .  2))
      ...
      ((default . error) (IDENTIFIER .  228) (CHARACTER_LITERAL .  230) (STRING_LITERAL .  229) (ALL .  231))
      ((default . error) (LEFT_PAREN .  223) (ACCESS .  220) (DELTA .  221) (DIGITS .  222) (MOD .  224) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (STRING_LITERAL .  49) (CHARACTER_LITERAL .  173) (RIGHT_PAREN . ((association_opt . 0) (expression_opt . 0))) (COMMA . ((association_opt . 0) (expression_opt . 0))) (EQUAL_GREATER . (discrete_choice_list . 0)) (BAR . (discrete_choice_list . 0)) (PLUS .  144) (MINUS .  143) (IDENTIFIER .  216) (OTHERS .  175) (ABS .  147) (NOT .  174) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (RAISE .  152) (LEFT_PAREN .  148))
      ((default . error) (WITH . (name_opt . 0)) (SEMICOLON . (name_opt . 0)) (IS . (name_opt . 0)) (RENAMES . (name_opt . 0)) (COLON_EQUAL . (name_opt . 0)) (RIGHT_PAREN . (name_opt . 0)) (DO . (name_opt . 0)) (ACCESS . (null_exclusion_opt . 0)) (NOT .  211) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ...
      ((default . error) (ACCESS . (mode_opt . 0)) (NOT . (mode_opt . 0)) (IDENTIFIER . (mode_opt . 0)) (STRING_LITERAL . (mode_opt . 0)) (CHARACTER_LITERAL . (mode_opt . 0)) (IN .  207) (OUT .  208))
      ...
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (IS .  203) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ((default . error) (WITH . (discriminant_part_opt . 0)) (SEMICOLON . (discriminant_part_opt . 0)) (IS . (discriminant_part_opt . 0)) (LEFT_PAREN .  201))
      ((default . error) (DOT .  87) (TICK .  88) (RENAMES .  200) (LEFT_PAREN .  106))
      ((default . error) (DOT .  87) (TICK .  88) (RENAMES .  199) (LEFT_PAREN .  106))
      ((default . error) (DOT .  87) (TICK .  88) (RENAMES .  198) (LEFT_PAREN .  106))
      ((default . error) (COMMA .  119) (SEMICOLON .  197))
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (NEW .  195))
      ((default . error) (IDENTIFIER .  48) (STRING_LITERAL .  49) (CHARACTER_LITERAL .  173) (RIGHT_PAREN . ((association_opt . 0) (expression_opt . 0))) (COMMA . ((association_opt . 0) (expression_opt . 0))) (EQUAL_GREATER . (discrete_choice_list . 0)) (BAR . (discrete_choice_list . 0)) (PLUS .  144) (MINUS .  143) (OTHERS .  175) (ABS .  147) (NOT .  174) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (RAISE .  152) (LEFT_PAREN .  148))
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (SEMICOLON . ((association_opt . 0) (expression_opt . 0))) (IS . ((association_opt . 0) (expression_opt . 0))) (COMMA . ((association_opt . 0) (expression_opt . 0))) (EQUAL_GREATER . (discrete_choice_list . 0)) (BAR . (discrete_choice_list . 0)) (OTHERS .  175) (IDENTIFIER .  48) (CHARACTER_LITERAL .  173) (STRING_LITERAL .  49) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  174) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (LEFT_PAREN .  148))
      ...
      ((default . error) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  146) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ...
      ((default . error) (BEGIN . (declarative_part_opt . 0)) (USE .  11) (SUBTYPE .  299) (PRAGMA .  7) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (ENTRY . (overriding_indicator_opt . 2)) (FOR .  296) (IDENTIFIER .  295) (TYPE .  301) (GENERIC .  2) (PROTECTED .  298) (TASK .  300) (PACKAGE .  297))
      ...
      ((default . error) (PROTECTED .  382) (TASK .  383) (PACKAGE .  381) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)))
      ...
      ((default . error) (EQUAL_GREATER .  379) (RIGHT_PAREN . (name . 0)) (COMMA . (name . 0)) (STAR_STAR . (name . 0)) (REM . (name . 0)) (MOD . (name . 0)) (STAR . (name . 0)) (SLASH . (name . 0)) (SLASH_EQUAL . (name . 0)) (LESS_EQUAL . (name . 0)) (LESS . (name . 0)) (GREATER_EQUAL . (name . 0)) (GREATER . (name . 0)) (EQUAL . (name . 0)) (NOT . (name . 0)) (IN . (name . 0)) (AMPERSAND . (name . 0)) (MINUS . (name . 0)) (PLUS . (name . 0)) (LEFT_PAREN . (name . 0)) (AND . (name . 0)) (OR . (name . 0)) (XOR . (name . 0)) (DOT . (name . 0)) (TICK . ( 380 (name . 0))))
      ((default . error) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (CASE .  232) (IF .  233) (FOR .  374) (RIGHT_PAREN . ((association_opt . 0) (expression_opt . 0))) (COMMA . ((association_opt . 0) (expression_opt . 0))) (EQUAL_GREATER . (discrete_choice_list . 0)) (BAR . (discrete_choice_list . 0)) (RAISE .  152) (PLUS .  144) (MINUS .  143) (OTHERS .  175) (ABS .  147) (NOT .  174) (IDENTIFIER .  48) (CHARACTER_LITERAL .  173) (STRING_LITERAL .  49) (NUMERIC_LITERAL .  145) (NULL .  234) (NEW .  149) (LEFT_PAREN .  148))
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ...
      ((default . error) (DO . (expression . 1)) (LOOP . (expression . 1)) (XOR . (expression . 1)) (OR . (expression . 1)) (AND . ( 368 (expression . 1))) (ELSIF . (expression . 1)) (ELSE . (expression . 1)) (EQUAL_GREATER . (expression . 1)) (DIGITS . (expression . 1)) (COMMA . (expression . 1)) (RIGHT_PAREN . (expression . 1)) (RANGE . (expression . 1)) (THEN . (expression . 1)) (WITH . (expression . 1)) (SEMICOLON . (expression . 1)) (IS . (expression . 1)))
      ((default . error) (DO . (expression . 2)) (LOOP . (expression . 2)) (XOR . (expression . 2)) (OR . (expression . 2)) (AND . ( 367 (expression . 2))) (ELSIF . (expression . 2)) (ELSE . (expression . 2)) (EQUAL_GREATER . (expression . 2)) (DIGITS . (expression . 2)) (COMMA . (expression . 2)) (RIGHT_PAREN . (expression . 2)) (RANGE . (expression . 2)) (THEN . (expression . 2)) (WITH . (expression . 2)) (SEMICOLON . (expression . 2)) (IS . (expression . 2)))
      ((default . error) (DO . (expression . 3)) (LOOP . (expression . 3)) (XOR . (expression . 3)) (OR . ( 366 (expression . 3))) (AND . (expression . 3)) (ELSIF . (expression . 3)) (ELSE . (expression . 3)) (EQUAL_GREATER . (expression . 3)) (DIGITS . (expression . 3)) (COMMA . (expression . 3)) (RIGHT_PAREN . (expression . 3)) (RANGE . (expression . 3)) (THEN . (expression . 3)) (WITH . (expression . 3)) (SEMICOLON . (expression . 3)) (IS . (expression . 3)))
      ((default . error) (DO . (expression . 4)) (LOOP . (expression . 4)) (XOR . (expression . 4)) (OR . ( 365 (expression . 4))) (AND . (expression . 4)) (ELSIF . (expression . 4)) (ELSE . (expression . 4)) (EQUAL_GREATER . (expression . 4)) (DIGITS . (expression . 4)) (COMMA . (expression . 4)) (RIGHT_PAREN . (expression . 4)) (RANGE . (expression . 4)) (THEN . (expression . 4)) (WITH . (expression . 4)) (SEMICOLON . (expression . 4)) (IS . (expression . 4)))
      ((default . error) (DO . (expression . 5)) (LOOP . (expression . 5)) (XOR . ( 364 (expression . 5))) (OR . (expression . 5)) (AND . (expression . 5)) (ELSIF . (expression . 5)) (ELSE . (expression . 5)) (EQUAL_GREATER . (expression . 5)) (DIGITS . (expression . 5)) (COMMA . (expression . 5)) (RIGHT_PAREN . (expression . 5)) (RANGE . (expression . 5)) (THEN . (expression . 5)) (WITH . (expression . 5)) (SEMICOLON . (expression . 5)) (IS . (expression . 5)))
      ((default . error) (DO . (expression . 0)) (LOOP . (expression . 0)) (XOR . ( 363 (expression . 0))) (OR . ( 362 (expression . 0))) (AND . ( 361 (expression . 0))) (ELSIF . (expression . 0)) (ELSE . (expression . 0)) (EQUAL_GREATER . (expression . 0)) (DIGITS . (expression . 0)) (COMMA . (expression . 0)) (RIGHT_PAREN . (expression . 0)) (RANGE . (expression . 0)) (THEN . (expression . 0)) (WITH . (expression . 0)) (SEMICOLON . (expression . 0)) (IS . (expression . 0)))
      ((default . error) (IN .  278) (NOT .  279) (DO . (relation . 0)) (LOOP . (relation . 0)) (COMMA . (relation . 0)) (ELSIF . (relation . 0)) (ELSE . (relation . 0)) (EQUAL_GREATER . (relation . 0)) (RIGHT_PAREN . (relation . 0)) (DIGITS . (relation . 0)) (RANGE . (relation . 0)) (THEN . (relation . 0)) (SEMICOLON . (relation . 0)) (WITH . (relation . 0)) (IS . (relation . 0)) (AND . (relation . 0)) (OR . (relation . 0)) (XOR . (relation . 0)) (EQUAL .  272) (SLASH_EQUAL .  277) (LESS .  275) (LESS_EQUAL .  276) (GREATER .  273) (GREATER_EQUAL .  274))
      ((default . error) (OF . (term_list . 0)) (COLON_EQUAL . (term_list . 0)) (DO . (term_list . 0)) (LOOP . (term_list . 0)) (ELSIF . (term_list . 0)) (ELSE . (term_list . 0)) (DIGITS . (term_list . 0)) (COMMA . (term_list . 0)) (RIGHT_PAREN . (term_list . 0)) (RANGE . (term_list . 0)) (THEN . (term_list . 0)) (WITH . (term_list . 0)) (BAR . (term_list . 0)) (EQUAL_GREATER . (term_list . 0)) (IS . (term_list . 0)) (SLASH_EQUAL . (term_list . 0)) (LESS_EQUAL . (term_list . 0)) (LESS . (term_list . 0)) (GREATER_EQUAL . (term_list . 0)) (GREATER . (term_list . 0)) (EQUAL . (term_list . 0)) (NOT . (term_list . 0)) (IN . (term_list . 0)) (AND . (term_list . 0)) (OR . (term_list . 0)) (XOR . (term_list . 0)) (SEMICOLON . (term_list . 0)) (DOT_DOT . (term_list . 0)) (AMPERSAND . (term_list . 0)) (MINUS . (term_list . 0)) (PLUS . (term_list . 0)) (STAR .  356) (SLASH .  355) (MOD .  357) (REM .  358))
      ((default . error) (OF . (simple_expression . 1)) (COLON_EQUAL . (simple_expression . 1)) (DO . (simple_expression . 1)) (LOOP . (simple_expression . 1)) (ELSIF . (simple_expression . 1)) (ELSE . (simple_expression . 1)) (DIGITS . (simple_expression . 1)) (RIGHT_PAREN . (simple_expression . 1)) (COMMA . (simple_expression . 1)) (RANGE . (simple_expression . 1)) (THEN . (simple_expression . 1)) (WITH . (simple_expression . 1)) (BAR . (simple_expression . 1)) (EQUAL_GREATER . (simple_expression . 1)) (IS . (simple_expression . 1)) (IN . (simple_expression . 1)) (NOT . (simple_expression . 1)) (EQUAL . (simple_expression . 1)) (GREATER . (simple_expression . 1)) (GREATER_EQUAL . (simple_expression . 1)) (LESS . (simple_expression . 1)) (LESS_EQUAL . (simple_expression . 1)) (SLASH_EQUAL . (simple_expression . 1)) (AND . (simple_expression . 1)) (OR . (simple_expression . 1)) (XOR . (simple_expression . 1)) (SEMICOLON . (simple_expression . 1)) (DOT_DOT . (simple_expression . 1)) (PLUS .  353) (MINUS .  352) (AMPERSAND .  351))
      ((default . error) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (IS .  349))
      ((default . error) (END . (declarative_part_opt . 0)) (PRIVATE . (declarative_part_opt . 0)) (USE .  11) (SUBTYPE .  299) (PRAGMA .  7) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (ENTRY . (overriding_indicator_opt . 2)) (FOR .  296) (IDENTIFIER .  295) (TYPE .  301) (GENERIC .  2) (PROTECTED .  298) (TASK .  300) (PACKAGE .  297))
      ((default . error) (SEMICOLON . (name . 1)) (IS . (name . 1)) (WITH . (name . 1)) (RANGE . (name . 1)) (TICK . (name . 1)) (LEFT_PAREN . (name . 1)) (DOT . (name . 1)) (PLUS . (name . 1)) (MINUS . (name . 1)) (AMPERSAND . (name . 1)) (DOT_DOT . (name . 1)) (IN . (name . 1)) (NOT . (name . 1)) (EQUAL . (name . 1)) (GREATER . (name . 1)) (GREATER_EQUAL . (name . 1)) (LESS . (name . 1)) (LESS_EQUAL . (name . 1)) (SLASH_EQUAL . (name . 1)) (RIGHT_PAREN . (name . 1)) (COMMA . (name . 1)) (SLASH . (name . 1)) (STAR . (name . 1)) (MOD . (name . 1)) (REM . (name . 1)) (STAR_STAR . (name . 1)) (BAR . (name . 1)) (AND . (name . 1)) (OR . (name . 1)) (XOR . (name . 1)) (EQUAL_GREATER . ((name . 1)  294)))
      ((default . error) (NUMERIC_LITERAL .  145) (NULL .  292) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ...
      ((default . error) (COMMA .  268) (SEMICOLON . (aspect_specification_opt . 1)) (IS . (aspect_specification_opt . 1)))
      ((default . error) (BAR . (discrete_choice . 0)) (EQUAL_GREATER . (discrete_choice . 0)))
      ((default . error) (AND .  291) (EQUAL_GREATER . (choice_expression . 1)) (BAR . (choice_expression . 1)))
      ((default . error) (OR .  290) (EQUAL_GREATER . (choice_expression . 2)) (BAR . (choice_expression . 2)))
      ((default . error) (XOR .  289) (EQUAL_GREATER . (choice_expression . 3)) (BAR . (choice_expression . 3)))
      ((default . error) (AND .  288) (EQUAL_GREATER . (choice_expression . 4)) (BAR . (choice_expression . 4)))
      ((default . error) (OR .  287) (EQUAL_GREATER . (choice_expression . 5)) (BAR . (choice_expression . 5)))
      ((default . error) (XOR .  286) (OR .  285) (AND .  284) (EQUAL_GREATER . (choice_expression . 0)) (BAR . (choice_expression . 0)))
      ...
      ((default . error) (DOT .  87) (DO . (primary . 3)) (LOOP . (primary . 3)) (ELSIF . (primary . 3)) (ELSE . (primary . 3)) (DIGITS . (primary . 3)) (RANGE . (primary . 3)) (THEN . (primary . 3)) (SEMICOLON . (primary . 3)) (IS . (primary . 3)) (WITH . (primary . 3)) (IN . (primary . 3)) (NOT . (primary . 3)) (RIGHT_PAREN . (primary . 3)) (COMMA . (primary . 3)) (PLUS . (primary . 3)) (MINUS . (primary . 3)) (AMPERSAND . (primary . 3)) (DOT_DOT . (primary . 3)) (SLASH . (primary . 3)) (STAR . (primary . 3)) (MOD . (primary . 3)) (REM . (primary . 3)) (STAR_STAR . (primary . 3)) (BAR . (primary . 3)) (EQUAL_GREATER . (primary . 3)) (EQUAL . (primary . 3)) (GREATER . (primary . 3)) (GREATER_EQUAL . (primary . 3)) (LESS . (primary . 3)) (LESS_EQUAL . (primary . 3)) (SLASH_EQUAL . (primary . 3)) (AND . (primary . 3)) (OR . (primary . 3)) (XOR . (primary . 3)) (TICK .  281) (LEFT_PAREN .  106))
      ((default . error) (BAR . (discrete_choice . 2)) (EQUAL_GREATER . (discrete_choice . 2)))
      ((default . error) (IN .  278) (NOT .  279) (SEMICOLON . (relation . 0)) (IS . (relation . 0)) (WITH . (relation . 0)) (RIGHT_PAREN . (relation . 0)) (COMMA . (relation . 0)) (DOT_DOT .  271) (BAR . (choice_relation . 1)) (EQUAL_GREATER . (choice_relation . 1)) (AND . ((relation . 0) (choice_relation . 1))) (OR . ((relation . 0) (choice_relation . 1))) (XOR . ((relation . 0) (choice_relation . 1))) (EQUAL .  272) (SLASH_EQUAL .  277) (LESS .  275) (LESS_EQUAL .  276) (GREATER .  273) (GREATER_EQUAL .  274))
      ((default . error) (DOT .  87) (TICK .  88) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108) (LEFT_PAREN .  106))
      ((default . error) (COMMA .  268) (RIGHT_PAREN .  269))
      ((default . error) (BAR . (discrete_choice . 2)) (EQUAL_GREATER . (discrete_choice . 2)) (RIGHT_PAREN .  267))
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ...
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (BOX .  258) (SEMICOLON . (discriminant_specification_opt . 0)) (RIGHT_PAREN . (discriminant_specification_opt . 0)) (IDENTIFIER .  72))
      ((default . error) (IS .  256) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ((default . error) (ABSTRACT .  252) (BOX .  251) (NULL .  253) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (SEMICOLON .  250))
      ((default . error) (DOT .  87) (TICK .  88) (IS .  249) (LEFT_PAREN .  106))
      ((default . error) (COLON . (identifier_list . 1)) (COMMA . (identifier_list . 1)))
      ((default . error) (OUT .  248) (ACCESS . (mode_opt . 1)) (NOT . (mode_opt . 1)) (IDENTIFIER . (mode_opt . 1)) (STRING_LITERAL . (mode_opt . 1)) (CHARACTER_LITERAL . (mode_opt . 1)))
      ...
      ((default . error) (IDENTIFIER . (null_exclusion_opt . 0)) (STRING_LITERAL . (null_exclusion_opt . 0)) (CHARACTER_LITERAL . (null_exclusion_opt . 0)) (ACCESS . (null_exclusion_opt . 0)) (NOT .  211))
      ((default . error) (IDENTIFIER . (null_exclusion_opt . 0)) (STRING_LITERAL . (null_exclusion_opt . 0)) (CHARACTER_LITERAL . (null_exclusion_opt . 0)) (RIGHT_PAREN . (null_exclusion_opt . 0)) (DO . (null_exclusion_opt . 0)) (RENAMES . (null_exclusion_opt . 0)) (COLON_EQUAL . (null_exclusion_opt . 0)) (WITH . (null_exclusion_opt . 0)) (SEMICOLON . (null_exclusion_opt . 0)) (IS . (null_exclusion_opt . 0)) (ACCESS . (null_exclusion_opt . 0)) (NOT .  211))
      ...
      ((default . error) (CASE .  232) (IF .  233) (RIGHT_PAREN . ((association_opt . 0) (expression_opt . 0))) (COMMA . ((association_opt . 0) (expression_opt . 0))) (EQUAL_GREATER . (discrete_choice_list . 0)) (BAR . (discrete_choice_list . 0)) (RAISE .  152) (PLUS .  144) (MINUS .  143) (OTHERS .  175) (ABS .  147) (NOT .  174) (IDENTIFIER .  48) (CHARACTER_LITERAL .  173) (STRING_LITERAL .  49) (NUMERIC_LITERAL .  145) (NULL .  234) (NEW .  149) (LEFT_PAREN .  148))
      ...
      ((default . error) (ACCESS . (aliased_opt . 0)) (NOT . (aliased_opt . 0)) (IN . (aliased_opt . 0)) (OUT . (aliased_opt . 0)) (IDENTIFIER . (aliased_opt . 0)) (STRING_LITERAL . (aliased_opt . 0)) (CHARACTER_LITERAL . (aliased_opt . 0)) (ALIASED .  517))
      ((default . error) (FUNCTION . (protected_opt . 0)) (PROCEDURE . (protected_opt . 0)) (PROTECTED .  514) (IDENTIFIER . (general_access_modifier_opt . 0)) (STRING_LITERAL . (general_access_modifier_opt . 0)) (CHARACTER_LITERAL . (general_access_modifier_opt . 0)) (ALL .  512) (CONSTANT .  513))
      ...
      ((default . error) (ACCESS .  242) (WITH . (name_opt . 0)) (SEMICOLON . (name_opt . 0)) (IS . (name_opt . 0)) (RENAMES . (name_opt . 0)) (COLON_EQUAL . (name_opt . 0)) (RIGHT_PAREN . (name_opt . 0)) (DO . (name_opt . 0)) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (COLON_EQUAL .  509) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ((default . error) (ACCESS .  242) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ...
      ((default . error) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108) (BOX .  251) (NULL .  253) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ...
      ((default . error) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ((default . error) (LEFT_PAREN .  489) (RANGE .  493) (MOD .  491) (DIGITS .  487) (DELTA .  486) (TASK .  496) (PROTECTED .  492) (INTERFACE .  488) (ARRAY .  485) (PRIVATE . (abstract_tagged_limited_opt . 0)) (TAGGED .  495) (NEW . (abstract_limited_synchronized_opt . 0)) (ABSTRACT .  484) (LIMITED .  490) (SYNCHRONIZED .  494) (ACCESS . (null_exclusion_opt . 0)) (NOT .  211))
      ...
      ((default . error) (RIGHT_PAREN . ((association_opt . 0) (expression_opt . 0))) (COMMA . ((association_opt . 0) (expression_opt . 0))) (IS . ((association_opt . 0) (expression_opt . 0))) (SEMICOLON . ((association_opt . 0) (expression_opt . 0))) (EQUAL_GREATER . (discrete_choice_list . 0)) (BAR . (discrete_choice_list . 0)) (OTHERS .  175) (IDENTIFIER .  48) (CHARACTER_LITERAL .  173) (STRING_LITERAL .  49) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  174) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (LEFT_PAREN .  148))
      ...
      ((default . error) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ...
      ((default . error) (PLUS .  144) (MINUS .  143) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (LEFT_PAREN .  148))
      ((default . error) (IN .  467))
      ((default . error) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (RANGE .  465) (LEFT_PAREN .  223) (ACCESS .  220) (DELTA .  221) (DIGITS .  222) (MOD .  224) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (OTHERS .  175) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  174) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (LEFT_PAREN .  148))
      ((default . error) (BOX .  461) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (THEN .  459) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (ELSE .  457) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ...
      ((default . error) (BOX .  447) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (COLON . ( 446 (identifier_list . 0))) (COMMA . (identifier_list . 0)))
      ((default . error) (IDENTIFIER .  441) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  442))
      ((default . error) (BODY .  440) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ...
      ((default . error) (END . (declarative_part_opt . 1)) (PRIVATE . (declarative_part_opt . 1)) (BEGIN . (declarative_part_opt . 1)) (USE .  11) (SUBTYPE .  299) (PRAGMA .  7) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (ENTRY . (overriding_indicator_opt . 2)) (FOR .  296) (IDENTIFIER .  295) (TYPE .  301) (GENERIC .  2) (PROTECTED .  298) (TASK .  300) (PACKAGE .  297))
      ...
      ((default . error) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (THEN .  418) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (ELSE .  416) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ...
      ((default . error) (OF . (term_list . 1)) (COLON_EQUAL . (term_list . 1)) (DO . (term_list . 1)) (LOOP . (term_list . 1)) (ELSIF . (term_list . 1)) (ELSE . (term_list . 1)) (DIGITS . (term_list . 1)) (COMMA . (term_list . 1)) (RIGHT_PAREN . (term_list . 1)) (RANGE . (term_list . 1)) (THEN . (term_list . 1)) (WITH . (term_list . 1)) (BAR . (term_list . 1)) (EQUAL_GREATER . (term_list . 1)) (IS . (term_list . 1)) (SLASH_EQUAL . (term_list . 1)) (LESS_EQUAL . (term_list . 1)) (LESS . (term_list . 1)) (GREATER_EQUAL . (term_list . 1)) (GREATER . (term_list . 1)) (EQUAL . (term_list . 1)) (NOT . (term_list . 1)) (IN . (term_list . 1)) (AND . (term_list . 1)) (OR . (term_list . 1)) (XOR . (term_list . 1)) (SEMICOLON . (term_list . 1)) (DOT_DOT . (term_list . 1)) (AMPERSAND . (term_list . 1)) (MINUS . (term_list . 1)) (PLUS . (term_list . 1)) (STAR .  356) (SLASH .  355) (MOD .  357) (REM .  358))
      ((default . error) (BEGIN .  606) (END .  607))
      ((default . error) (IDENTIFIER .  605))
      ((default . error) (IS . ( 604 (subprogram_specification . 1))) (WITH . (subprogram_specification . 1)) (SEMICOLON . (subprogram_specification . 1)) (RENAMES . (subprogram_specification . 1)))
      ((default . error) (IS . ( 603 (subprogram_specification . 0))) (WITH . (subprogram_specification . 0)) (SEMICOLON . (subprogram_specification . 0)) (RENAMES . (subprogram_specification . 0)))
      ((default . error) (RENAMES .  127) (SEMICOLON . (aspect_specification_opt . 0)) (IS . ( 602 (aspect_specification_opt . 0))) (WITH .  108))
      ((default . error) (EXCEPTION .  600) (CONSTANT . ( 599 (aliased_opt . 0))) (ARRAY . (aliased_opt . 0)) (ACCESS . (aliased_opt . 0)) (NOT . (aliased_opt . 0)) (IDENTIFIER . (aliased_opt . 0)) (STRING_LITERAL . (aliased_opt . 0)) (CHARACTER_LITERAL . (aliased_opt . 0)) (ALIASED .  517))
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (END . (declarative_part_opt . 0)) (USE .  11) (SUBTYPE .  299) (PRAGMA .  7) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (ENTRY . (overriding_indicator_opt . 2)) (FOR .  296) (IDENTIFIER .  295) (TYPE .  301) (GENERIC .  2) (PROTECTED .  298) (TASK .  300) (PACKAGE .  297))
      ...
      ((default . error) (IS . (discriminant_part_opt . 0)) (SEMICOLON . (discriminant_part_opt . 0)) (LEFT_PAREN .  201))
      ...
      ((default . error) (USE . ( 587 (name . 4))) (LEFT_PAREN . (name . 4)) (DOT . (name . 4)) (TICK . (name . 4)))
      ((default . error) (USE .  586))
      ((default . error) (DOT .  87) (TICK .  88) (USE .  585) (LEFT_PAREN .  106))
      ((default . error) (EXCEPTION .  582) (IDENTIFIER . (null_exclusion_opt . 0)) (STRING_LITERAL . (null_exclusion_opt . 0)) (CHARACTER_LITERAL . (null_exclusion_opt . 0)) (ACCESS . (null_exclusion_opt . 0)) (NOT .  211))
      ...
      ((default . error) (XOR . (choice_relation . 1)) (OR . (choice_relation . 1)) (BAR . (choice_relation . 1)) (EQUAL_GREATER . (choice_relation . 1)) (AND . (choice_relation . 1)) (EQUAL .  272) (SLASH_EQUAL .  277) (LESS .  275) (LESS_EQUAL .  276) (GREATER .  273) (GREATER_EQUAL .  274))
      ...
      ((default . error) (DOT_DOT .  271) (BAR . (choice_relation . 1)) (EQUAL_GREATER . (choice_relation . 1)) (AND . (choice_relation . 1)) (OR . (choice_relation . 1)) (XOR . (choice_relation . 1)) (EQUAL .  272) (SLASH_EQUAL .  277) (LESS .  275) (LESS_EQUAL .  276) (GREATER .  273) (GREATER_EQUAL .  274))
      ((default . error) (LOOP . (range . 1)) (DO . (range . 1)) (COMMA . (range . 1)) (OF . (range . 1)) (COLON_EQUAL . (range . 1)) (ELSIF . (range . 1)) (ELSE . (range . 1)) (DIGITS . (range . 1)) (RANGE . (range . 1)) (THEN . (range . 1)) (SEMICOLON . (range . 1)) (WITH . (range . 1)) (IS . (range . 1)) (AND . (range . 1)) (OR . (range . 1)) (XOR . (range . 1)) (RIGHT_PAREN . (range . 1)) (EQUAL_GREATER . (range . 1)) (BAR . (range . 1)) (LEFT_PAREN .  576))
      ...
      ((default . error) (PLUS .  144) (MINUS .  143) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (LEFT_PAREN .  148))
      ((default . error) (BAR .  574) (DO . (relation . 3)) (LOOP . (relation . 3)) (COMMA . (relation . 3)) (ELSIF . (relation . 3)) (ELSE . (relation . 3)) (EQUAL_GREATER . (relation . 3)) (RIGHT_PAREN . (relation . 3)) (DIGITS . (relation . 3)) (RANGE . (relation . 3)) (THEN . (relation . 3)) (SEMICOLON . (relation . 3)) (WITH . (relation . 3)) (IS . (relation . 3)) (AND . (relation . 3)) (OR . (relation . 3)) (XOR . (relation . 3)))
      ...
      ((default . error) (DOT_DOT .  271) (DO . (membership_choice . 0)) (LOOP . (membership_choice . 0)) (COMMA . (membership_choice . 0)) (ELSIF . (membership_choice . 0)) (ELSE . (membership_choice . 0)) (EQUAL_GREATER . (membership_choice . 0)) (RIGHT_PAREN . (membership_choice . 0)) (DIGITS . (membership_choice . 0)) (RANGE . (membership_choice . 0)) (THEN . (membership_choice . 0)) (SEMICOLON . (membership_choice . 0)) (WITH . (membership_choice . 0)) (IS . (membership_choice . 0)) (AND . (membership_choice . 0)) (OR . (membership_choice . 0)) (XOR . (membership_choice . 0)) (BAR . (membership_choice . 0)))
      ...
      ((default . error) (ACCESS . (null_exclusion_opt . 0)) (NOT .  565) (IDENTIFIER .  564) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ...
      ((default . error) (TAGGED .  562) (NEW . (abstract_limited_synchronized_opt . 3)) (SYNCHRONIZED .  561) (LIMITED .  560))
      ...
      ((default . error) (INTERFACE .  555) (PRIVATE . (abstract_tagged_limited_opt . 5)) (NEW . (abstract_limited_synchronized_opt . 4)))
      ((default . error) (BOX .  554))
      ((default . error) (INTERFACE .  553))
      ((default . error) (BOX .  552))
      ((default . error) (INTERFACE .  551) (NEW . (abstract_limited_synchronized_opt . 5)))
      ((default . error) (PRIVATE . (abstract_tagged_limited_opt . 4)) (LIMITED .  549) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ...
      ((default . error) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (DOT .  87) (TICK .  88) (COLON_EQUAL .  539) (LEFT_PAREN .  106) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ((default . error) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ...
      ((default . error) (IDENTIFIER . (mode_opt . 0)) (STRING_LITERAL . (mode_opt . 0)) (CHARACTER_LITERAL . (mode_opt . 0)) (IN .  207) (OUT .  208) (ACCESS . (null_exclusion_opt . 0)) (NOT . ((mode_opt . 0)  211)))
      ...
      ((default . error) (RIGHT_PAREN . ((association_opt . 0) (expression_opt . 0))) (COMMA . ((association_opt . 0) (expression_opt . 0))) (EQUAL_GREATER . (discrete_choice_list . 0)) (BAR . (discrete_choice_list . 0)) (OTHERS .  175) (IDENTIFIER .  48) (CHARACTER_LITERAL .  173) (STRING_LITERAL .  49) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  174) (NUMERIC_LITERAL .  145) (NULL .  530) (NEW .  149) (LEFT_PAREN .  148))
      ...
      ((default . error) (COLON_EQUAL .  791) (RIGHT_PAREN . (parameter_specification . 3)) (SEMICOLON . (parameter_specification . 3)))
      ((default . error) (IDENTIFIER . (null_exclusion_opt . 0)) (STRING_LITERAL . (null_exclusion_opt . 0)) (CHARACTER_LITERAL . (null_exclusion_opt . 0)) (NOT .  211))
      ((default . error) (RETURN .  90) (LEFT_PAREN .  787))
      ((default . error) (IS . (parameter_profile_opt . 0)) (SEMICOLON . (parameter_profile_opt . 0)) (WITH . (parameter_profile_opt . 0)) (COLON_EQUAL . (parameter_profile_opt . 0)) (RENAMES . (parameter_profile_opt . 0)) (DO . (parameter_profile_opt . 0)) (RIGHT_PAREN . (parameter_profile_opt . 0)) (LEFT_PAREN .  787))
      ...
      ((default . error) (DOT .  87) (TICK .  88) (WITH . (formal_package_actual_part . 1)) (SEMICOLON . (formal_package_actual_part . 1)) (LEFT_PAREN .  782))
      ...
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  763) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (LEFT_PAREN .  148))
      ((default . error) (NEW . (abstract_limited_synchronized_opt . 1)))
      ((default . error) (NEW . (abstract_limited_synchronized_opt . 2)))
      ((default . error) (LIMITED .  762) (RECORD . (abstract_tagged_limited_opt . 2)) (NULL . (abstract_tagged_limited_opt . 2)) (PRIVATE . (abstract_tagged_limited_opt . 2)))
      ...
      ((default . error) (SEMICOLON . (discriminant_specification_opt . 4)) (RIGHT_PAREN . (discriminant_specification_opt . 4)) (COLON_EQUAL .  760))
      ((default . error) (DOT .  87) (TICK .  88) (LEFT_PAREN .  106))
      ((default . error) (SEMICOLON . (discriminant_specification_opt . 2)) (RIGHT_PAREN . (discriminant_specification_opt . 2)) (COLON_EQUAL .  759))
      ...
      ((default . error) (PLUS .  144) (MINUS .  143) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (LEFT_PAREN .  148))
      ((default . error) (BAR .  574) (LOOP . (relation . 2)) (DO . (relation . 2)) (XOR . (relation . 2)) (OR . (relation . 2)) (AND . (relation . 2)) (IS . (relation . 2)) (WITH . (relation . 2)) (SEMICOLON . (relation . 2)) (THEN . (relation . 2)) (RANGE . (relation . 2)) (DIGITS . (relation . 2)) (RIGHT_PAREN . (relation . 2)) (EQUAL_GREATER . (relation . 2)) (ELSE . (relation . 2)) (ELSIF . (relation . 2)) (COMMA . (relation . 2)))
      ((default . error) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ...
      ((default . error) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (DOT .  87) (TICK .  88) (IS . ( 747 (aspect_specification_opt . 0))) (WITH .  108) (LEFT_PAREN .  106))
      ((default . error) (WITH . (discriminant_part_opt . 0)) (IS . (discriminant_part_opt . 0)) (LEFT_PAREN .  201))
      ((default . error) (IS . ( 745 (aspect_specification_opt . 0))) (WITH .  108))
      ((default . error) (IS .  744))
      ((default . error) (NOT .  741) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (WITH . (discriminant_part_opt . 0)) (IS . (discriminant_part_opt . 0)) (SEMICOLON . (discriminant_part_opt . 0)) (LEFT_PAREN .  201))
      ...
      ((default . error) (IDENTIFIER . (constant_opt . 0)) (STRING_LITERAL . (constant_opt . 0)) (CHARACTER_LITERAL . (constant_opt . 0)) (NOT . (constant_opt . 0)) (ACCESS . (constant_opt . 0)) (ARRAY . (constant_opt . 0)) (CONSTANT .  730))
      ((default . error) (SEPARATE .  729) (ABSTRACT .  728))
      ((default . error) (NULL .  727))
      ((default . error) (LEFT_PAREN .  725))
      ((default . error) (WITH . (parameter_profile_opt . 0)) (SEMICOLON . (parameter_profile_opt . 0)) (LEFT_PAREN .  723))
      ((default . error) (END . (sequence_of_statements_opt . 0)) (EXCEPTION . (sequence_of_statements_opt . 0)) (ACCEPT . (label_opt . 0)) (BEGIN . (label_opt . 0)) (CASE . (label_opt . 0)) (DECLARE . (label_opt . 0)) (FOR . (label_opt . 0)) (IF . (label_opt . 0)) (LOOP . (label_opt . 0)) (RETURN . (label_opt . 0)) (SELECT . (label_opt . 0)) (WHILE . (label_opt . 0)) (STRING_LITERAL . (label_opt . 0)) (CHARACTER_LITERAL . (label_opt . 0)) (ABORT . (label_opt . 0)) (DELAY . (label_opt . 0)) (EXIT . (label_opt . 0)) (GOTO . (label_opt . 0)) (NULL . (label_opt . 0)) (PRAGMA . (label_opt . 0)) (RAISE . (label_opt . 0)) (REQUEUE . (label_opt . 0)) (LESS_LESS .  619) (IDENTIFIER . ((label_opt . 0)  620)))
      ...
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (END . (sequence_of_statements_opt . 0)) (EXCEPTION . (sequence_of_statements_opt . 0)) (ACCEPT . (label_opt . 0)) (BEGIN . (label_opt . 0)) (CASE . (label_opt . 0)) (DECLARE . (label_opt . 0)) (FOR . (label_opt . 0)) (IF . (label_opt . 0)) (LOOP . (label_opt . 0)) (RETURN . (label_opt . 0)) (SELECT . (label_opt . 0)) (WHILE . (label_opt . 0)) (STRING_LITERAL . (label_opt . 0)) (CHARACTER_LITERAL . (label_opt . 0)) (ABORT . (label_opt . 0)) (DELAY . (label_opt . 0)) (EXIT . (label_opt . 0)) (GOTO . (label_opt . 0)) (NULL . (label_opt . 0)) (PRAGMA . (label_opt . 0)) (RAISE . (label_opt . 0)) (REQUEUE . (label_opt . 0)) (LESS_LESS .  619) (IDENTIFIER . ((label_opt . 0)  620)))
      ((default . error) (IS . (expression_opt . 0)) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (BEGIN . (declarative_part_opt . 0)) (USE .  11) (SUBTYPE .  299) (PRAGMA .  7) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (ENTRY . (overriding_indicator_opt . 2)) (FOR .  296) (IDENTIFIER .  295) (TYPE .  301) (GENERIC .  2) (PROTECTED .  298) (TASK .  300) (PACKAGE .  297))
      ((default . error) (UNTIL .  705) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (WHEN . (identifier_opt . 0)) (SEMICOLON . (identifier_opt . 0)) (IDENTIFIER .  703))
      ((default . error) (LOOP . (iterator_specification_opt . 0)) (IDENTIFIER .  613))
      ((default . error) (IDENTIFIER .  700))
      ((default . error) (THEN . (expression_opt . 0)) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (END . (sequence_of_statements_opt . 0)) (ACCEPT . (label_opt . 0)) (BEGIN . (label_opt . 0)) (CASE . (label_opt . 0)) (DECLARE . (label_opt . 0)) (FOR . (label_opt . 0)) (IF . (label_opt . 0)) (LOOP . (label_opt . 0)) (RETURN . (label_opt . 0)) (SELECT . (label_opt . 0)) (WHILE . (label_opt . 0)) (STRING_LITERAL . (label_opt . 0)) (CHARACTER_LITERAL . (label_opt . 0)) (ABORT . (label_opt . 0)) (DELAY . (label_opt . 0)) (EXIT . (label_opt . 0)) (GOTO . (label_opt . 0)) (NULL . (label_opt . 0)) (PRAGMA . (label_opt . 0)) (RAISE . (label_opt . 0)) (REQUEUE . (label_opt . 0)) (LESS_LESS .  619) (IDENTIFIER . ((label_opt . 0)  620)))
      ((default . error) (SEMICOLON .  697))
      ((default . error) (SEMICOLON .  695) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (SEMICOLON .  689) (DO . (extended_return_object_declaration_opt . 0)) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  690) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (ELSE . (select_alternative_list_opt . 0)) (END . (select_alternative_list_opt . 0)) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (DELAY .  626) (WHEN .  678) (TERMINATE .  677) (ACCEPT .  621))
      ((default . error) (LOOP . (expression_opt . 0)) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ...
      ((default . error) (NULL .  632) (GOTO .  629) (ABORT .  622) (ACCEPT .  621) (DECLARE .  625) (BEGIN .  623) (LOOP .  631) (CASE .  624) (IF .  630) (PRAGMA .  7) (RAISE .  633) (DELAY .  626) (REQUEUE .  634) (RETURN .  635) (EXIT .  627) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (WHILE .  637) (FOR .  628) (SELECT .  636))
      ...
      ((default . error) (DOT .  87) (SEMICOLON .  671) (TICK .  88) (COLON_EQUAL .  670) (LEFT_PAREN .  106))
      ...
      ((default . error) (END . (handled_sequence_of_statements . 1)) (EXCEPTION .  668))
      ...
      ((default . error) (END . (exception_handler_list_opt . 0)) (WHEN .  940))
      ...
      ((default . error) (WITH .  918) (DOT .  87) (TICK .  88) (SEMICOLON .  917) (LEFT_PAREN .  106))
      ...
      ((default . error) (DOT .  87) (TICK .  88) (SEMICOLON .  906) (LEFT_PAREN .  106))
      ((default . error) (SEMICOLON . (actual_parameter_part_opt . 0)) (DO . (actual_parameter_part_opt . 0)) (LEFT_PAREN . ((actual_parameter_part_opt . 0)  903)))
      ...
      ((default . error) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (NOT .  741) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (REVERSE .  896) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  763) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (LEFT_PAREN .  148))
      ((default . error) (REVERSE .  894) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (SEMICOLON .  893))
      ((default . error) (END .  892))
      ((default . error) (IDENTIFIER .  216) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  763) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (LEFT_PAREN .  148))
      ((default . error) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ((default . error) (CASE .  232) (IF .  233) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ((default . error) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ((default . error) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ((default . error) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ...
      ((default . error) (ARRAY .  485) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (ACCESS . (null_exclusion_opt . 0)) (NOT .  878))
      ...
      ((default . error) (PRIVATE . (abstract_tagged_limited_opt . 0)) (NULL . (abstract_tagged_limited_opt . 0)) (RECORD . (abstract_tagged_limited_opt . 0)) (TAGGED .  865) (RANGE .  863) (MOD .  861) (DIGITS .  858) (DELTA .  857) (TASK .  496) (PROTECTED .  492) (SYNCHRONIZED .  494) (INTERFACE .  488) (ARRAY .  485) (LEFT_PAREN .  859) (ACCESS . (null_exclusion_opt . 0)) (NOT .  211) (NEW . ((abstract_limited_synchronized_opt . 0) (abstract_limited_opt . 0))) (LIMITED .  860) (ABSTRACT .  856))
      ...
      ((default . error) (NEW .  853) (END . (declarative_part_opt . 0)) (PRIVATE . (declarative_part_opt . 0)) (USE .  11) (SUBTYPE .  299) (PRAGMA .  7) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (ENTRY . (overriding_indicator_opt . 2)) (FOR .  296) (IDENTIFIER .  295) (TYPE .  301) (GENERIC .  2) (PROTECTED .  298) (TASK .  300) (PACKAGE .  297))
      ((default . error) (SEPARATE .  852))
      ((default . error) (SEMICOLON . (aspect_specification_opt . 0)) (IS . (aspect_specification_opt . 0)) (WITH .  108))
      ((default . error) (NULL .  850))
      ((default . error) (DO . (subtype_indication . 3)) (OF . (subtype_indication . 3)) (AND . (subtype_indication . 3)) (SEMICOLON . (subtype_indication . 3)) (WITH . (subtype_indication . 3)) (COLON_EQUAL . (subtype_indication . 3)) (DOT .  87) (TICK .  88) (RANGE .  849) (LEFT_PAREN .  819))
      ((default . error) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ((default . error) (NEW .  845) (END . (declarative_part_opt . 0)) (PRIVATE . (declarative_part_opt . 0)) (USE .  11) (SUBTYPE .  299) (PRAGMA .  7) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (ENTRY . (overriding_indicator_opt . 2)) (FOR .  296) (IDENTIFIER .  295) (TYPE .  301) (GENERIC .  2) (PROTECTED .  298) (TASK .  300) (PACKAGE .  297))
      ...
      ((default . error) (DOT .  87) (TICK .  88) (RENAMES .  835) (LEFT_PAREN .  106))
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ...
      ((default . error) (NUMERIC_LITERAL .  145) (NULL .  827) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ...
      ((default . error) (RIGHT_PAREN . (subtype_indication . 3)) (COMMA . (subtype_indication . 3)) (PLUS . (primary . 3)) (MINUS . (primary . 3)) (AMPERSAND . (primary . 3)) (DOT_DOT . (primary . 3)) (SLASH . (primary . 3)) (STAR . (primary . 3)) (MOD . (primary . 3)) (REM . (primary . 3)) (STAR_STAR . (primary . 3)) (DOT .  87) (TICK .  281) (RANGE .  820) (LEFT_PAREN .  819))
      ...
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (DOT .  87) (TICK .  88) (WITH . (and_interface_list_opt . 0)) (SEMICOLON . (and_interface_list_opt . 0)) (AND .  811) (LEFT_PAREN .  106))
      ...
      ((default . error) (BOX .  810) (IDENTIFIER .  48) (STRING_LITERAL .  49) (CHARACTER_LITERAL .  173) (RIGHT_PAREN . ((association_opt . 0) (expression_opt . 0))) (COMMA . ((association_opt . 0) (expression_opt . 0))) (EQUAL_GREATER . (discrete_choice_list . 0)) (BAR . (discrete_choice_list . 0)) (PLUS .  144) (MINUS .  143) (OTHERS .  175) (ABS .  147) (NOT .  174) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (RAISE .  152) (LEFT_PAREN .  148))
      ((default . error) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ...
      ((default . error) (ELSE .  800) (RIGHT_PAREN . (if_expression . 3)) (ELSIF .  801))
      ((default . error) (EQUAL_GREATER . (discrete_choice_list . 0)) (BAR . (discrete_choice_list . 0)) (OTHERS .  175) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  174) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (LEFT_PAREN .  148))
      ...
      ((default . error) (RIGHT_PAREN . (if_expression . 1)) (ELSE .  1072) (ELSIF .  801))
      ...
      ((default . error) (COLON_EQUAL .  1071) (DOT .  87) (TICK .  88) (RIGHT_PAREN . (parameter_specification . 1)) (SEMICOLON . (parameter_specification . 1)) (LEFT_PAREN .  106))
      ...
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (WITH . ( 1066 (formal_derived_type_definition . 1))) (SEMICOLON . (formal_derived_type_definition . 1)))
      ((default . error) (AND .  1065) (WITH . (interface_type_definition . 1)) (SEMICOLON . (interface_type_definition . 1)))
      ((default . error) (DOT .  87) (SEMICOLON . (interface_list . 0)) (WITH . (interface_list . 0)) (AND . (interface_list . 0)) (TICK .  88) (LEFT_PAREN .  106))
      ((default . error) (AND .  1065) (WITH . (interface_type_definition . 3)) (SEMICOLON . (interface_type_definition . 3)))
      ((default . error) (AND .  1065) (WITH . (interface_type_definition . 2)) (SEMICOLON . (interface_type_definition . 2)))
      ((default . error) (AND .  1065) (WITH . (interface_type_definition . 0)) (SEMICOLON . (interface_type_definition . 0)))
      ((default . error) (SEMICOLON . (formal_type_definition . 7)) (WITH . (formal_type_definition . 7)))
      ((default . error) (IDENTIFIER .  48) (STRING_LITERAL .  49) (CHARACTER_LITERAL .  173) (RIGHT_PAREN . ((association_opt . 0) (expression_opt . 0))) (COMMA . ((association_opt . 0) (expression_opt . 0))) (EQUAL_GREATER . (discrete_choice_list . 0)) (BAR . (discrete_choice_list . 0)) (PLUS .  144) (MINUS .  143) (OTHERS .  175) (ABS .  147) (NOT .  1062) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (RAISE .  152) (LEFT_PAREN .  148))
      ((default . error) (BOX .  1061) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (LEFT_PAREN .  148))
      ...
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (LEFT_PAREN .  148))
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ...
      ((default . error) (SYNCHRONIZED .  561) (TAGGED .  562) (NEW . ((abstract_limited_synchronized_opt . 3) (abstract_limited_opt . 3))) (LIMITED .  1030))
      ((default . error) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (IDENTIFIER .  1024) (CHARACTER_LITERAL .  1025))
      ((default . error) (INTERFACE .  555) (PRIVATE . (abstract_tagged_limited_opt . 5)) (NULL . (abstract_tagged_limited_opt . 5)) (RECORD . (abstract_tagged_limited_opt . 5)) (NEW . ((abstract_limited_synchronized_opt . 4) (abstract_limited_opt . 2))))
      ((default . error) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (RECORD .  1022))
      ((default . error) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (END . (component_list_opt . 0)) (NULL .  1013) (CASE .  1012) (IDENTIFIER .  72) (FOR .  296))
      ((default . error) (SEMICOLON .  1011) (PRIVATE . (abstract_tagged_limited_opt . 4)) (NULL . (abstract_tagged_limited_opt . 4)) (RECORD . (abstract_tagged_limited_opt . 4)) (LIMITED .  549))
      ...
      ((default . error) (COLON_EQUAL .  1002) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ((default . error) (COLON_EQUAL .  1000) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ...
      ((default . error) (END . (protected_operation_item_list_opt . 0)) (ENTRY .  976) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (FOR .  296))
      ((default . error) (BEGIN . (declarative_part_opt . 0)) (USE .  11) (SUBTYPE .  299) (PRAGMA .  7) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (ENTRY . (overriding_indicator_opt . 2)) (FOR .  296) (IDENTIFIER .  295) (TYPE .  301) (GENERIC .  2) (PROTECTED .  298) (TASK .  300) (PACKAGE .  297))
      ...
      ((default . error) (RIGHT_PAREN . ((association_opt . 0) (expression_opt . 0))) (COMMA . ((association_opt . 0) (expression_opt . 0))) (EQUAL_GREATER . (discrete_choice_list . 0)) (BAR . (discrete_choice_list . 0)) (OTHERS .  175) (IDENTIFIER .  48) (CHARACTER_LITERAL .  173) (STRING_LITERAL .  49) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  174) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (LEFT_PAREN .  148))
      ...
      ((default . error) (DO . (parameter_profile_opt . 0)) (SEMICOLON . (parameter_profile_opt . 0)) (LEFT_PAREN .  787))
      ...
      ((default . error) (SEMICOLON . (identifier_opt . 0)) (IDENTIFIER .  703))
      ...
      ((default . error) (SEMICOLON . (expression_opt . 0)) (RAISE .  152) (PLUS .  144) (MINUS .  143) (ABS .  147) (NOT .  150) (NUMERIC_LITERAL .  145) (NULL .  151) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ...
      ((default . error) (CONSTANT . (aliased_opt . 0)) (IDENTIFIER . (aliased_opt . 0)) (STRING_LITERAL . (aliased_opt . 0)) (CHARACTER_LITERAL . (aliased_opt . 0)) (ACCESS . (aliased_opt . 0)) (NOT . (aliased_opt . 0)) (ALIASED .  517))
      ((default . error) (ABORT .  960))
      ((default . error) (END . (sequence_of_statements_opt . 0)) (ACCEPT . (label_opt . 0)) (BEGIN . (label_opt . 0)) (CASE . (label_opt . 0)) (DECLARE . (label_opt . 0)) (FOR . (label_opt . 0)) (IF . (label_opt . 0)) (LOOP . (label_opt . 0)) (RETURN . (label_opt . 0)) (SELECT . (label_opt . 0)) (WHILE . (label_opt . 0)) (STRING_LITERAL . (label_opt . 0)) (CHARACTER_LITERAL . (label_opt . 0)) (ABORT . (label_opt . 0)) (DELAY . (label_opt . 0)) (EXIT . (label_opt . 0)) (GOTO . (label_opt . 0)) (NULL . (label_opt . 0)) (PRAGMA . (label_opt . 0)) (RAISE . (label_opt . 0)) (REQUEUE . (label_opt . 0)) (LESS_LESS .  619) (IDENTIFIER . ((label_opt . 0)  620)))
      ((default . error) (SELECT .  958))
      ((default . error) (WHEN .  678) (TERMINATE .  677) (ACCEPT .  621) (DELAY .  626))
      ...
      ((default . error) (OTHERS .  946) (IDENTIFIER .  945) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (END . (exception_handler_list . 0)) (WHEN . (exception_handler_list . 0)))
      ((default . error) (END . (exception_handler_list_opt . 1)) (WHEN .  940))
      ...
      ((default . error) (COLON .  1178) (EQUAL_GREATER . (name . 0)) (BAR . (name . 0)) (LEFT_PAREN . (name . 0)) (DOT . (name . 0)) (TICK . (name . 0)))
      ...
      ((default . error) (END . (sequence_of_statements_opt . 0)) (ACCEPT . (label_opt . 0)) (BEGIN . (label_opt . 0)) (CASE . (label_opt . 0)) (DECLARE . (label_opt . 0)) (FOR . (label_opt . 0)) (IF . (label_opt . 0)) (LOOP . (label_opt . 0)) (RETURN . (label_opt . 0)) (SELECT . (label_opt . 0)) (WHILE . (label_opt . 0)) (STRING_LITERAL . (label_opt . 0)) (CHARACTER_LITERAL . (label_opt . 0)) (ABORT . (label_opt . 0)) (DELAY . (label_opt . 0)) (EXIT . (label_opt . 0)) (GOTO . (label_opt . 0)) (NULL . (label_opt . 0)) (PRAGMA . (label_opt . 0)) (RAISE . (label_opt . 0)) (REQUEUE . (label_opt . 0)) (LESS_LESS .  619) (IDENTIFIER . ((label_opt . 0)  620)))
      ((default . error) (IDENTIFIER . (constant_opt . 0)) (STRING_LITERAL . (constant_opt . 0)) (CHARACTER_LITERAL . (constant_opt . 0)) (ACCESS . (constant_opt . 0)) (NOT . (constant_opt . 0)) (CONSTANT .  730))
      ...
      ((default . error) (END . (protected_operation_item_list_opt . 1)) (ENTRY .  976) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (FOR .  296))
      ...
      ((default . error) (REVERSE .  1141) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ...
      ((default . error) (WITH . (parameter_profile_opt . 0)) (SEMICOLON . (parameter_profile_opt . 0)) (LEFT_PAREN .  787))
      ...
      ((default . error) (IS . (direct_name_opt . 0)) (IDENTIFIER .  1125) (STRING_LITERAL .  1126))
      ...
      ((default . error) (WHEN . (component_list_opt . 1)) (END . (component_list_opt . 1)) (CASE .  1012) (IDENTIFIER .  72) (FOR .  296))
      ...
      ((default . error) (WITH . (real_range_specification_opt . 0)) (SEMICOLON . (real_range_specification_opt . 0)) (RANGE .  1114))
      ((default . error) (DIGITS .  1113) (WITH . (real_range_specification_opt . 0)) (SEMICOLON . (real_range_specification_opt . 0)) (RANGE .  1114))
      ...
      ((default . error) (NEW .  1107) (END . (declarative_part_opt . 0)) (PRIVATE . (declarative_part_opt . 0)) (USE .  11) (SUBTYPE .  299) (PRAGMA .  7) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (ENTRY . (overriding_indicator_opt . 2)) (FOR .  296) (IDENTIFIER .  295) (TYPE .  301) (GENERIC .  2) (PROTECTED .  298) (TASK .  300) (PACKAGE .  297))
      ((default . error) (DO . (subtype_indication . 1)) (LOOP . (subtype_indication . 1)) (COLON_EQUAL . (subtype_indication . 1)) (SEMICOLON . (subtype_indication . 1)) (OF . (subtype_indication . 1)) (AND . (subtype_indication . 1)) (WITH . (subtype_indication . 1)) (EQUAL_GREATER . (subtype_indication . 1)) (COMMA . (subtype_indication . 1)) (RIGHT_PAREN . (subtype_indication . 1)) (DOT .  87) (TICK .  88) (RANGE .  849) (LEFT_PAREN .  819))
      ...
      ((default . error) (NEW .  1100) (END . (declarative_part_opt . 0)) (PRIVATE . (declarative_part_opt . 0)) (USE .  11) (SUBTYPE .  299) (PRAGMA .  7) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (ENTRY . (overriding_indicator_opt . 2)) (FOR .  296) (IDENTIFIER .  295) (TYPE .  301) (GENERIC .  2) (PROTECTED .  298) (TASK .  300) (PACKAGE .  297))
      ...
      ((default . error) (ALIASED .  1087) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (ACCESS . (null_exclusion_opt . 0)) (NOT .  878))
      ...
      ((default . error) (DOT .  87) (RANGE .  1086) (TICK .  88) (LEFT_PAREN .  106))
      ((default . error) (COMMA . (index_subtype_definition . 0)) (RIGHT_PAREN . (index_subtype_definition . 0)))
      ((default . error) (NUMERIC_LITERAL .  145) (NULL .  1085) (NEW .  149) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (LEFT_PAREN .  148))
      ((default . error) (COMMA .  825) (RIGHT_PAREN .  1084))
      ((default . error) (COMMA . (discrete_subtype_definition . 1)) (BAR . (discrete_choice . 2)) (EQUAL_GREATER . (discrete_choice . 2)) (RIGHT_PAREN . ((discrete_subtype_definition . 1)  267)))
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (PRIVATE .  1082))
      ((default . error) (AND .  1065) (WITH . (and_interface_list_opt . 1)) (SEMICOLON . (and_interface_list_opt . 1)))
      ...
      ((default . error) (ACCESS . (null_exclusion_opt . 0)) (NOT .  878) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ...
      ((default . error) (DOT .  87) (TICK .  88) (AND .  811) (WITH . ((and_interface_list_opt . 0) (constraint_opt . 0))) (SEMICOLON . (constraint_opt . 0)) (RANGE .  849) (LEFT_PAREN .  819))
      ...
      ((default . error) (SEMICOLON . (aspect_specification_opt . 0)) (IS . (aspect_specification_opt . 0)) (WITH .  108))
      ((default . error) (WHEN . (parameter_profile_opt . 0)) (LEFT_PAREN .  1205))
      ((default . error) (END . (sequence_of_statements_opt . 0)) (EXCEPTION . (sequence_of_statements_opt . 0)) (ACCEPT . (label_opt . 0)) (BEGIN . (label_opt . 0)) (CASE . (label_opt . 0)) (DECLARE . (label_opt . 0)) (FOR . (label_opt . 0)) (IF . (label_opt . 0)) (LOOP . (label_opt . 0)) (RETURN . (label_opt . 0)) (SELECT . (label_opt . 0)) (WHILE . (label_opt . 0)) (STRING_LITERAL . (label_opt . 0)) (CHARACTER_LITERAL . (label_opt . 0)) (ABORT . (label_opt . 0)) (DELAY . (label_opt . 0)) (EXIT . (label_opt . 0)) (GOTO . (label_opt . 0)) (NULL . (label_opt . 0)) (PRAGMA . (label_opt . 0)) (RAISE . (label_opt . 0)) (REQUEUE . (label_opt . 0)) (LESS_LESS .  619) (IDENTIFIER . ((label_opt . 0)  620)))
      ...
      ((default . error) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49) (ACCESS . (null_exclusion_opt . 0)) (NOT .  878))
      ...
      ((default . error) (SEMICOLON . (identifier_opt . 0)) (IDENTIFIER .  703))
      ((default . error) (OTHERS .  946) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ((default . error) (WHEN . (sequence_of_statements_opt . 0)) (END . (sequence_of_statements_opt . 0)) (ACCEPT . (label_opt . 0)) (BEGIN . (label_opt . 0)) (CASE . (label_opt . 0)) (DECLARE . (label_opt . 0)) (FOR . (label_opt . 0)) (IF . (label_opt . 0)) (LOOP . (label_opt . 0)) (RETURN . (label_opt . 0)) (SELECT . (label_opt . 0)) (WHILE . (label_opt . 0)) (STRING_LITERAL . (label_opt . 0)) (CHARACTER_LITERAL . (label_opt . 0)) (ABORT . (label_opt . 0)) (DELAY . (label_opt . 0)) (EXIT . (label_opt . 0)) (GOTO . (label_opt . 0)) (NULL . (label_opt . 0)) (PRAGMA . (label_opt . 0)) (RAISE . (label_opt . 0)) (REQUEUE . (label_opt . 0)) (LESS_LESS .  619) (IDENTIFIER . ((label_opt . 0)  620)))
      ((default . error) (OTHERS .  946) (IDENTIFIER .  48) (CHARACTER_LITERAL .  50) (STRING_LITERAL .  49))
      ...
      ((default . error) (DO . (extended_return_object_declaration . 1)) (SEMICOLON . (extended_return_object_declaration . 1)) (COLON_EQUAL .  1276))
      ...
      ((default . error) (COLON_EQUAL .  1251) (SEMICOLON . (aspect_specification_opt . 0)) (WITH .  108))
      ...
      ((default . error) (RIGHT_PAREN . (subtype_indication . 1)) (COMMA . (subtype_indication . 1)) (DOT .  87) (TICK .  88) (BAR . (discrete_choice . 1)) (EQUAL_GREATER . (discrete_choice . 1)) (RANGE .  849) (LEFT_PAREN .  819))
      ...
      ((default . error) (END . (component_list_opt . 0)) (WHEN . (component_list_opt . 0)) (NULL .  1013) (CASE .  1012) (IDENTIFIER .  72) (FOR .  296))
      ...
      ((default . error) (END . (sequence_of_statements_opt . 0)) (EXCEPTION . (sequence_of_statements_opt . 0)) (ACCEPT . (label_opt . 0)) (BEGIN . (label_opt . 0)) (CASE . (label_opt . 0)) (DECLARE . (label_opt . 0)) (FOR . (label_opt . 0)) (IF . (label_opt . 0)) (LOOP . (label_opt . 0)) (RETURN . (label_opt . 0)) (SELECT . (label_opt . 0)) (WHILE . (label_opt . 0)) (STRING_LITERAL . (label_opt . 0)) (CHARACTER_LITERAL . (label_opt . 0)) (ABORT . (label_opt . 0)) (DELAY . (label_opt . 0)) (EXIT . (label_opt . 0)) (GOTO . (label_opt . 0)) (NULL . (label_opt . 0)) (PRAGMA . (label_opt . 0)) (RAISE . (label_opt . 0)) (REQUEUE . (label_opt . 0)) (LESS_LESS .  619) (IDENTIFIER . ((label_opt . 0)  620)))
      ((default . error) (WHEN . (parameter_profile_opt . 0)) (LEFT_PAREN .  787))
     ...
     [((compilation_unit . 13)(compilation_unit_list . 14)(context_item . 15)(function_specification . 16)(generic_declaration . 17)(generic_formal_part . 18)(generic_instantiation . 19)(generic_package_declaration . 20)(generic_renaming_declaration . 21)(generic_subprogram_declaration . 22)(library_item . 23)(library_unit_declaration . 24)(library_unit_renaming_declaration . 25)(overriding_indicator_opt . 26)(package_body . 27)(package_declaration . 28)(package_renaming_declaration . 29)(package_specification . 30)(pragma . 31)(procedure_specification . 32)(subprogram_body . 33)(subprogram_declaration . 34)(subprogram_renaming_declaration . 35)(subunit . 36)(use_clause . 37)(with_clause . 38))
      ...
      nil
      ((aggregate . 225)(attribute_reference . 51)(attribute_designator . 226)(name . 227)(qualified_expression . 54)(selected_component . 55))
      ((aggregate . 153)(association_opt . 176)(association_list . 193)(attribute_reference . 51)(choice_expression . 178)(choice_relation_and_list . 179)(choice_relation_or_list . 180)(choice_relation_xor_list . 181)(choice_relation_and_then_list . 182)(choice_relation_or_else_list . 183)(choice_relation . 184)(discrete_choice . 185)(discrete_choice_list . 186)(expression . 187)(expression_opt . 188)(factor . 155)(identifier_list . 217)(name . 189)(parameter_specification . 218)(parameter_specification_list . 219)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(range . 194)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 191)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((access_definition . 212)(attribute_reference . 51)(name . 213)(name_opt . 214)(null_exclusion_opt . 215)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      nil
      ((mode_opt . 209))
      nil
      nil
      ((attribute_reference . 51)(name . 205)(qualified_expression . 54)(selected_component . 55))
      ...
      ((actual_parameter_part . 91))
      nil
      ((attribute_reference . 51)(name_list . 196)(name . 53)(qualified_expression . 54)(selected_component . 55))
      nil
      ((aggregate . 153)(association_opt . 176)(association_list . 193)(attribute_reference . 51)(choice_expression . 178)(choice_relation_and_list . 179)(choice_relation_or_list . 180)(choice_relation_xor_list . 181)(choice_relation_and_then_list . 182)(choice_relation_or_else_list . 183)(choice_relation . 184)(discrete_choice . 185)(discrete_choice_list . 186)(expression . 187)(expression_opt . 188)(factor . 155)(name . 189)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(range . 194)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 191)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((attribute_reference . 51)(name . 192)(qualified_expression . 54)(selected_component . 55))
      ((aggregate . 153)(association_opt . 176)(association_list . 177)(attribute_reference . 51)(choice_expression . 178)(choice_relation_and_list . 179)(choice_relation_or_list . 180)(choice_relation_xor_list . 181)(choice_relation_and_then_list . 182)(choice_relation_or_else_list . 183)(choice_relation . 184)(discrete_choice . 185)(discrete_choice_list . 186)(expression . 187)(expression_opt . 188)(factor . 155)(name . 189)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(range . 190)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 191)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((actual_parameter_part . 91)(aspect_specification_opt . 171))
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 154)(factor . 155)(name . 156)(pragma_argument_association . 157)(pragma_argument_association_list . 158)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ...
      nil
      nil
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 388)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      ((actual_parameter_part . 91)(aspect_specification_opt . 387))
      nil
      nil
      nil
      ((actual_parameter_part . 91))
      ((function_specification . 16)(overriding_indicator_opt . 384)(package_body . 324)(procedure_specification . 32)(proper_body . 385)(protected_body . 332)(subprogram_body . 339)(task_body . 344))
      nil
      nil
      nil
      nil
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(name . 156)(primary . 378)(qualified_expression . 54)(selected_component . 55))
      ((aggregate . 153)(association_opt . 176)(association_list . 235)(attribute_reference . 51)(case_expression . 375)(choice_expression . 178)(choice_relation_and_list . 179)(choice_relation_or_list . 180)(choice_relation_xor_list . 181)(choice_relation_and_then_list . 182)(choice_relation_or_else_list . 183)(choice_relation . 184)(discrete_choice . 185)(discrete_choice_list . 186)(expression . 237)(expression_opt . 188)(factor . 155)(if_expression . 376)(name . 189)(primary . 159)(qualified_expression . 54)(quantified_expression . 377)(raise_expression . 160)(range . 190)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 191)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((attribute_reference . 51)(name . 373)(qualified_expression . 54)(selected_component . 55))
      ((aggregate . 153)(attribute_reference . 51)(name . 156)(primary . 293)(qualified_expression . 54)(selected_component . 55))
      nil
      ...
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(term . 168)(term_list . 350))
      nil
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 309)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      nil
      ((aggregate . 153)(attribute_reference . 51)(name . 156)(primary . 293)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      ...
      ((discriminant_specification_opt . 259)(discriminant_specification_list . 260)(identifier_list . 261))
      ((aspect_specification_opt . 257))
      ((attribute_reference . 51)(name . 254)(qualified_expression . 54)(selected_component . 55)(subprogram_default . 255))
      nil
      ((actual_parameter_part . 91))
      nil
      nil
      ...
      nil
      nil
      ((aggregate . 153)(association_opt . 176)(association_list . 235)(attribute_reference . 51)(case_expression . 236)(choice_expression . 178)(choice_relation_and_list . 179)(choice_relation_or_list . 180)(choice_relation_xor_list . 181)(choice_relation_and_then_list . 182)(choice_relation_or_else_list . 183)(choice_relation . 184)(discrete_choice . 185)(discrete_choice_list . 186)(expression . 237)(expression_opt . 188)(factor . 155)(if_expression . 238)(name . 189)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(range . 190)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 191)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      ((actual_parameter_part . 91))
      ...
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 526)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(expression . 525)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((attribute_reference . 51)(name . 213)(name_opt . 511)(qualified_expression . 54)(selected_component . 55))
      ((aspect_specification_opt . 510))
      ((attribute_reference . 51)(name . 508)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      nil
      nil
      ((aspect_specification_opt . 505)(attribute_reference . 51)(name . 254)(qualified_expression . 54)(selected_component . 55)(subprogram_default . 506))
      nil
      ((actual_parameter_part . 91))
      ((aspect_specification_opt . 504))
      ((abstract_limited_synchronized_opt . 497)(abstract_tagged_limited_opt . 498)(access_definition . 499)(array_type_definition . 500)(formal_type_definition . 501)(formal_derived_type_definition . 502)(interface_type_definition . 503)(null_exclusion_opt . 215))
      nil
      nil
      nil
      nil
      ...
      nil
      ((aggregate . 153)(association_opt . 474)(attribute_reference . 51)(choice_expression . 178)(choice_relation_and_list . 179)(choice_relation_or_list . 180)(choice_relation_xor_list . 181)(choice_relation_and_then_list . 182)(choice_relation_or_else_list . 183)(choice_relation . 184)(discrete_choice . 185)(discrete_choice_list . 186)(expression . 187)(expression_opt . 188)(factor . 155)(name . 189)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(range . 190)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 191)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 472)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      nil
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(membership_choice_list . 468)(membership_choice . 469)(name . 189)(primary . 159)(qualified_expression . 54)(range . 470)(selected_component . 55)(simple_expression . 471)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 466)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 225)(attribute_reference . 51)(attribute_designator . 226)(name . 227)(qualified_expression . 54)(selected_component . 55))
      ((aggregate . 153)(attribute_reference . 51)(choice_expression . 178)(choice_relation_and_list . 179)(choice_relation_or_list . 180)(choice_relation_xor_list . 181)(choice_relation_and_then_list . 182)(choice_relation_or_else_list . 183)(choice_relation . 184)(discrete_choice . 463)(factor . 155)(name . 189)(primary . 159)(qualified_expression . 54)(range . 190)(selected_component . 55)(simple_expression . 464)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(expression . 462)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(choice_relation . 460)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 451)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(choice_relation . 458)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 451)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(choice_relation . 456)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 451)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(choice_relation . 453)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 451)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(choice_relation . 452)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 451)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(choice_relation . 450)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 451)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((attribute_reference . 51)(name . 449)(qualified_expression . 54)(selected_component . 55))
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 448)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((attribute_reference . 443)(direct_name . 444)(name . 445)(qualified_expression . 54)(selected_component . 55))
      ((attribute_reference . 51)(name . 68)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      nil
      ...
      nil
      nil
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 431)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((function_specification . 425)(procedure_specification . 426)(subprogram_specification . 427))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 423)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      ((binary_adding_operator . 354))
      nil
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(term . 422))
      nil
      nil
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 421)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55))
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 420)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation . 419)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation . 417)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation . 415)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation . 414)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation . 412)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation . 410)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(name . 156)(primary . 409)(qualified_expression . 54)(selected_component . 55))
      ((aggregate . 153)(attribute_reference . 51)(expression . 154)(factor . 155)(name . 156)(pragma_argument_association . 408)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((actual_parameter_part . 91))
      ((actual_parameter_part . 91))
      ((quantifier . 405))
      ...
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 399)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      nil
      ((function_specification . 16)(procedure_specification . 32)(subprogram_specification . 395))
      nil
      nil
      nil
      nil
      ((attribute_reference . 51)(name . 392)(qualified_expression . 54)(selected_component . 55))
      ((attribute_reference . 51)(name . 391)(qualified_expression . 54)(selected_component . 55))
      ((actual_parameter_part . 91)(aspect_specification_opt . 665))
      ((actual_parameter_part . 91)(aspect_specification_opt . 664))
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(handled_sequence_of_statements . 647)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 660)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      ...
      ((aggregate . 153)(attribute_reference . 51)(expression . 612)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation . 611)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation . 610)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation . 609)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation . 608)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      ((multiplying_operator . 359))
      ...
      ((aspect_specification_opt . 128))
      ((aliased_opt . 601))
      ((attribute_reference . 51)(name . 598)(qualified_expression . 54)(selected_component . 55))
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 597)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      nil
      ...
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(choice_relation . 581)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 451)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(choice_relation . 580)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 451)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((aggregate . 153)(attribute_reference . 51)(choice_relation . 579)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 451)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((aggregate . 153)(attribute_reference . 51)(choice_relation . 578)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 451)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(membership_choice_list . 575)(membership_choice . 469)(name . 189)(primary . 159)(qualified_expression . 54)(range . 470)(selected_component . 55)(simple_expression . 471)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((access_definition . 566)(attribute_reference . 51)(name . 567)(null_exclusion_opt . 215)(null_exclusion_opt_name_type . 568)(qualified_expression . 54)(selected_component . 569))
      ...
      ((attribute_reference . 51)(name . 541)(qualified_expression . 54)(selected_component . 55))
      ((actual_parameter_part . 91)(aspect_specification_opt . 540))
      ((aggregate . 153)(attribute_reference . 51)(expression . 538)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      nil
      nil
      ((attribute_reference . 51)(name . 536)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      ((access_definition . 532)(mode_opt . 533)(null_exclusion_opt . 215))
      nil
      nil
      ((aggregate . 153)(association_opt . 176)(association_list . 531)(attribute_reference . 51)(choice_expression . 178)(choice_relation_and_list . 179)(choice_relation_or_list . 180)(choice_relation_xor_list . 181)(choice_relation_and_then_list . 182)(choice_relation_or_else_list . 183)(choice_relation . 184)(discrete_choice . 185)(discrete_choice_list . 186)(expression . 187)(expression_opt . 188)(factor . 155)(name . 189)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(range . 190)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 191)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      nil
      ...
      ((aggregate . 153)(attribute_reference . 51)(expression . 794)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      nil
      ...
      ((aggregate . 153)(attribute_reference . 51)(expression . 785)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ...
      nil
      nil
      ((attribute_reference . 51)(name . 779)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(discrete_subtype_definition . 764)(discrete_subtype_definition_list . 765)(factor . 155)(index_subtype_definition . 766)(index_subtype_definition_list . 767)(name . 768)(primary . 159)(qualified_expression . 54)(range . 769)(selected_component . 55)(simple_expression . 770)(subtype_indication . 771)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(membership_choice . 758)(name . 189)(primary . 159)(qualified_expression . 54)(range . 470)(selected_component . 55)(simple_expression . 471)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 757)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 756)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      nil
      nil
      nil
      ((attribute_reference . 51)(name . 753)(qualified_expression . 54)(selected_component . 55))
      ((aggregate . 751)(record_rep . 752))
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 748)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((actual_parameter_part . 91)(aspect_specification_opt . 171))
      ((discriminant_part_opt . 746))
      ((aspect_specification_opt . 715))
      nil
      ((attribute_reference . 51)(name . 742)(qualified_expression . 54)(selected_component . 55)(subtype_indication . 743))
      ...
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(handled_sequence_of_statements . 722)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 660)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      ((attribute_reference . 51)(name . 213)(name_opt . 721)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 716)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aspect_specification_opt . 715))
      ((aspect_specification_opt . 714))
      nil
      nil
      nil
      nil
      ((attribute_reference . 51)(name . 710)(qualified_expression . 54)(selected_component . 55))
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(handled_sequence_of_statements . 709)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 660)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      ((aggregate . 153)(attribute_reference . 51)(expression . 187)(expression_opt . 708)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 707)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      ((aggregate . 153)(attribute_reference . 51)(expression . 706)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((identifier_opt . 704))
      ((iterator_specification . 701)(iterator_specification_opt . 702))
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 187)(expression_opt . 699)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 698)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      ((attribute_reference . 51)(name . 696)(qualified_expression . 54)(selected_component . 55))
      ((attribute_reference . 51)(name . 694)(qualified_expression . 54)(selected_component . 55))
      ((aggregate . 153)(attribute_reference . 51)(expression . 691)(extended_return_object_declaration . 692)(extended_return_object_declaration_opt . 693)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((accept_statement . 679)(attribute_reference . 51)(delay_alternative . 680)(delay_statement . 681)(entry_call_alternative . 682)(name . 683)(procedure_call_statement . 684)(qualified_expression . 54)(selected_component . 55)(select_alternative . 685)(select_alternative_list . 686)(select_alternative_list_opt . 687)(triggering_alternative . 688))
      ((aggregate . 153)(attribute_reference . 51)(expression . 187)(expression_opt . 676)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(compound_statement . 672)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(simple_return_statement . 661)(simple_statement . 673)(timed_entry_call . 663))
      nil
      ((actual_parameter_part . 91))
      nil
      nil
      ...
      nil
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(simple_return_statement . 661)(statement . 669)(timed_entry_call . 663))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((exception_handler . 941)(exception_handler_list . 942)(exception_handler_list_opt . 943))
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 939)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 938)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      ((attribute_reference . 51)(name . 213)(name_opt . 937)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 935)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 934)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 933)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      ((accept_statement . 638)(actual_parameter_part . 91)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 930)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 929)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 911)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 899)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((attribute_reference . 51)(name . 742)(qualified_expression . 54)(selected_component . 55)(subtype_indication . 898))
      ((aggregate . 153)(attribute_reference . 51)(discrete_subtype_definition . 897)(factor . 155)(name . 891)(primary . 159)(qualified_expression . 54)(range . 769)(selected_component . 55)(simple_expression . 770)(subtype_indication . 771)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((attribute_reference . 51)(name . 895)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(discrete_subtype_definition . 890)(factor . 155)(identifier_list . 217)(name . 891)(parameter_specification . 218)(parameter_specification_list . 219)(primary . 159)(qualified_expression . 54)(range . 769)(selected_component . 55)(simple_expression . 770)(subtype_indication . 771)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aspect_specification_opt . 889))
      ((aggregate . 153)(attribute_reference . 51)(case_expression . 886)(expression . 887)(factor . 155)(if_expression . 888)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aspect_specification_opt . 885))
      ((aspect_specification_opt . 884))
      ((aspect_specification_opt . 883))
      ((aspect_specification_opt . 882))
      nil
      ((access_definition . 879)(array_type_definition . 880)(attribute_reference . 51)(name . 742)(null_exclusion_opt . 215)(qualified_expression . 54)(selected_component . 55)(subtype_indication . 881))
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 877)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((attribute_reference . 51)(name . 213)(name_opt . 876)(qualified_expression . 54)(selected_component . 55))
      nil
      ((abstract_limited_synchronized_opt . 866)(abstract_limited_opt . 867)(abstract_tagged_limited_opt . 868)(access_definition . 869)(array_type_definition . 870)(derived_type_definition . 871)(enumeration_type_definition . 872)(interface_type_definition . 873)(null_exclusion_opt . 215)(record_type_definition . 874)(type_definition . 875))
      nil
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 854)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_definition . 855)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      nil
      ((aspect_specification_opt . 851))
      nil
      ((actual_parameter_part . 91)(constraint . 821)(index_constraint . 822))
      ((aspect_specification_opt . 848))
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 846)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_definition . 847)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      nil
      ((aspect_specification_opt . 843))
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 840)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((mod_clause_opt . 839))
      nil
      nil
      ((actual_parameter_part . 91))
      ((attribute_reference . 51)(name . 834)(qualified_expression . 54)(selected_component . 55))
      ((attribute_reference . 51)(name . 833)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 831)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(expression . 830)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((attribute_reference . 51)(name . 567)(qualified_expression . 54)(selected_component . 829))
      nil
      ((aggregate . 153)(attribute_reference . 51)(name . 156)(primary . 293)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      ...
      nil
      nil
      ((attribute_reference . 51)(interface_list . 817)(name . 814)(qualified_expression . 54)(selected_component . 55))
      ((attribute_reference . 51)(interface_list . 816)(name . 814)(qualified_expression . 54)(selected_component . 55))
      ((attribute_reference . 51)(interface_list . 815)(name . 814)(qualified_expression . 54)(selected_component . 55))
      nil
      ((attribute_reference . 51)(interface_list . 813)(name . 814)(qualified_expression . 54)(selected_component . 55))
      ...
      nil
      ((identifier_list . 217)(parameter_specification . 218)(parameter_specification_list . 219))
      nil
      nil
      ((attribute_reference . 51)(name . 806)(qualified_expression . 54)(selected_component . 55))
      ((aggregate . 153)(attribute_reference . 51)(expression . 805)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      ((elsif_expression_item . 802)(elsif_expression_list . 803))
      ((aggregate . 153)(attribute_reference . 51)(choice_expression . 178)(choice_relation_and_list . 179)(choice_relation_or_list . 180)(choice_relation_xor_list . 181)(choice_relation_and_then_list . 182)(choice_relation_or_else_list . 183)(choice_relation . 184)(discrete_choice . 185)(discrete_choice_list . 799)(factor . 155)(name . 189)(primary . 159)(qualified_expression . 54)(range . 190)(selected_component . 55)(simple_expression . 464)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      ((case_expression_alternative . 1077))
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 1075)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(expression . 1074)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ...
      nil
      nil
      ((attribute_reference . 51)(interface_list . 1067)(name . 814)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      ((actual_parameter_part . 91))
      nil
      ...
      nil
      nil
      ((aggregate . 153)(association_opt . 176)(association_list . 193)(attribute_reference . 51)(choice_expression . 178)(choice_relation_and_list . 179)(choice_relation_or_list . 180)(choice_relation_xor_list . 181)(choice_relation_and_then_list . 182)(choice_relation_or_else_list . 183)(choice_relation . 184)(discrete_choice . 185)(discrete_choice_list . 186)(discrete_subtype_definition . 764)(discrete_subtype_definition_list . 1063)(expression . 187)(expression_opt . 188)(factor . 155)(name . 891)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(range . 1064)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 191)(subtype_indication . 771)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 189)(primary . 159)(qualified_expression . 54)(range . 1039)(selected_component . 55)(simple_expression . 770)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      ((attribute_reference . 51)(index_subtype_definition . 1059)(name . 1060)(qualified_expression . 54)(selected_component . 55))
      nil
      ((aggregate . 153)(attribute_reference . 51)(discrete_subtype_definition . 1057)(factor . 155)(name . 891)(primary . 159)(qualified_expression . 54)(range . 769)(selected_component . 55)(simple_expression . 770)(subtype_indication . 771)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((attribute_reference . 51)(name . 1038)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      nil
      nil
      ...
      ((attribute_reference . 51)(name . 1053)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      nil
      ...
      ((attribute_reference . 51)(interface_list . 1044)(name . 814)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 189)(primary . 159)(qualified_expression . 54)(range . 1039)(selected_component . 55)(simple_expression . 770)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ...
      ((attribute_reference . 51)(interface_list . 1034)(name . 814)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 1029)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(expression . 1028)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((enumeration_literal . 1026)(enumeration_literal_list . 1027))
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 1023)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 1021)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aspect_clause . 1014)(at_clause . 304)(component_declaration . 1015)(component_item . 1016)(component_list . 1017)(component_list_opt . 1018)(enumeration_representation_clause . 311)(identifier_list . 1019)(record_representation_clause . 335)(variant_part . 1020))
      nil
      nil
      nil
      ...
      nil
      ((actual_parameter_part . 91)(constraint . 821)(index_constraint . 822))
      ((attribute_reference . 51)(name . 213)(name_opt . 988)(qualified_expression . 54)(selected_component . 55))
      nil
      ((attribute_reference . 51)(name . 987)(qualified_expression . 54)(selected_component . 55))
      ((actual_parameter_part . 91))
      ((aggregate . 153)(attribute_reference . 51)(discrete_subtype_definition . 986)(factor . 155)(name . 891)(primary . 159)(qualified_expression . 54)(range . 769)(selected_component . 55)(simple_expression . 770)(subtype_indication . 771)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      ((aspect_clause . 977)(at_clause . 304)(entry_body . 978)(enumeration_representation_clause . 311)(function_specification . 16)(overriding_indicator_opt . 979)(procedure_specification . 32)(protected_operation_item . 980)(protected_operation_item_list . 981)(protected_operation_item_list_opt . 982)(record_representation_clause . 335)(subprogram_body . 983)(subprogram_declaration . 984))
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 975)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      nil
      ((aggregate . 153)(association_opt . 176)(association_list . 193)(attribute_reference . 51)(choice_expression . 178)(choice_relation_and_list . 179)(choice_relation_or_list . 180)(choice_relation_xor_list . 181)(choice_relation_and_then_list . 182)(choice_relation_or_else_list . 183)(choice_relation . 184)(discrete_choice . 185)(discrete_choice_list . 186)(expression . 187)(expression_opt . 188)(factor . 155)(name . 189)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(range . 190)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 191)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ...
      nil
      ((identifier_opt . 973))
      ((case_statement_alternative . 971)(case_statement_alternative_list . 972))
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(handled_sequence_of_statements . 969)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 660)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 187)(expression_opt . 967)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 966)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 964)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(handled_sequence_of_statements . 962)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 660)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      nil
      ((aliased_opt . 961))
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 959)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      ((accept_statement . 679)(delay_alternative . 680)(delay_statement . 955)(select_alternative . 957))
      nil
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 956)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      ...
      nil
      nil
      ((attribute_reference . 51)(exception_choice . 947)(exception_choice_list . 948)(name . 949)(qualified_expression . 54)(selected_component . 55))
      nil
      ...
      nil
      nil
      ((accept_statement . 1173)(delay_alternative . 1174)(delay_statement . 955))
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 1170)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      nil
      nil
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 1166)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      ((constant_opt . 1165))
      nil
      nil
      nil
      ...
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(choice_expression . 178)(choice_relation_and_list . 179)(choice_relation_or_list . 180)(choice_relation_xor_list . 181)(choice_relation_and_then_list . 182)(choice_relation_or_else_list . 183)(choice_relation . 184)(discrete_choice . 185)(discrete_choice_list . 1153)(factor . 155)(name . 189)(primary . 159)(qualified_expression . 54)(range . 190)(selected_component . 55)(simple_expression . 464)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ...
      nil
      nil
      ((function_specification . 16)(procedure_specification . 32)(subprogram_specification . 1145))
      nil
      ((aspect_clause . 977)(at_clause . 304)(entry_body . 978)(enumeration_representation_clause . 311)(function_specification . 16)(overriding_indicator_opt . 979)(procedure_specification . 32)(protected_operation_item . 1144)(record_representation_clause . 335)(subprogram_body . 983)(subprogram_declaration . 984))
      nil
      nil
      nil
      ((attribute_reference . 51)(name . 1142)(qualified_expression . 54)(selected_component . 55))
      nil
      ((actual_parameter_part . 91))
      nil
      ...
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 1138)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 1136)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 1134)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((attribute_reference . 51)(name . 1038)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      ...
      ((attribute_reference . 51)(name . 742)(qualified_expression . 54)(selected_component . 55)(subtype_indication . 1129))
      nil
      ...
      nil
      nil
      ((aspect_clause . 1014)(at_clause . 304)(component_declaration . 1015)(component_item . 1122)(enumeration_representation_clause . 311)(identifier_list . 1019)(record_representation_clause . 335)(variant_part . 1123))
      nil
      nil
      nil
      nil
      ...
      nil
      ((identifier_opt . 1112))
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 1111)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      nil
      nil
      nil
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 854)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_definition . 1108)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      ((actual_parameter_part . 91)(constraint . 1106)(index_constraint . 822))
      nil
      nil
      nil
      ((identifier_opt . 1105))
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 1104)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      nil
      nil
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 846)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_definition . 1101)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      nil
      nil
      nil
      nil
      ((component_clause . 1097))
      ((aggregate . 153)(attribute_reference . 51)(expression . 1095)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((actual_parameter_part . 91)(aspect_specification_opt . 1094))
      nil
      nil
      ((access_definition . 1088)(attribute_reference . 51)(component_definition . 1091)(name . 742)(null_exclusion_opt . 215)(qualified_expression . 54)(selected_component . 55)(subtype_indication . 1090))
      nil
      ((access_definition . 1088)(attribute_reference . 51)(component_definition . 1089)(name . 742)(null_exclusion_opt . 215)(qualified_expression . 54)(selected_component . 55)(subtype_indication . 1090))
      nil
      ((actual_parameter_part . 91))
      nil
      ((aggregate . 153)(attribute_reference . 51)(name . 156)(primary . 293)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      ((attribute_reference . 51)(name . 1083)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      nil
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 1081)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(expression . 1080)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 1078)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 1241)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      ((actual_parameter_part . 91))
      nil
      ((attribute_reference . 51)(name . 1240)(qualified_expression . 54)(selected_component . 55))
      nil
      ((access_definition . 1238)(attribute_reference . 51)(name . 742)(null_exclusion_opt . 215)(qualified_expression . 54)(selected_component . 55)(subtype_indication . 1239))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 1234)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((attribute_reference . 51)(interface_list . 1233)(name . 814)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 846)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_definition . 1231)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      nil
      nil
      nil
      ((attribute_reference . 51)(interface_list . 1229)(name . 814)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 854)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_definition . 1227)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 1225)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 1224)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      ((enumeration_literal . 1223))
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 1222)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((access_definition . 1088)(attribute_reference . 51)(component_definition . 1221)(name . 742)(null_exclusion_opt . 215)(qualified_expression . 54)(selected_component . 55)(subtype_indication . 1090))
      nil
      nil
      nil
      nil
      ...
      ((actual_parameter_part . 91)(and_interface_list_opt . 1215)(constraint . 1216)(constraint_opt . 1217)(index_constraint . 822))
      nil
      nil
      nil
      ...
      nil
      ((attribute_reference . 51)(name . 1209)(qualified_expression . 54)(selected_component . 55))
      ((actual_parameter_part . 91))
      ((identifier_opt . 1208))
      nil
      ((aspect_specification_opt . 128))
      ((entry_body_formal_part . 1206)(formal_part . 116)(parameter_profile_opt . 1207))
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(handled_sequence_of_statements . 1204)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 660)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(handled_sequence_of_statements . 1203)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 660)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      nil
      nil
      nil
      ((identifier_opt . 1200))
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 1199)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      ((aggregate . 153)(attribute_reference . 51)(expression . 187)(expression_opt . 1198)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      ...
      nil
      nil
      ((access_definition . 1189)(attribute_reference . 51)(name . 742)(null_exclusion_opt . 215)(qualified_expression . 54)(return_subtype_indication . 1190)(selected_component . 55)(subtype_indication . 1191))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 1183)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      ((identifier_opt . 1182))
      ((attribute_reference . 51)(exception_choice . 1181)(name . 949)(qualified_expression . 54)(selected_component . 55))
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 1180)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      ((attribute_reference . 51)(exception_choice . 947)(exception_choice_list . 1179)(name . 949)(qualified_expression . 54)(selected_component . 55))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 1274)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      nil
      nil
      nil
      nil
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 1268)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      nil
      nil
      ((identifier_list . 217)(parameter_specification . 218)(parameter_specification_list . 219))
      ...
      ((actual_parameter_part . 91)(constraint . 1106)(index_constraint . 822))
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 1304)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 846)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_definition . 1303)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      nil
      nil
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 854)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_definition . 1302)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      nil
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 1301)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((aggregate . 153)(attribute_reference . 51)(expression . 1300)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((aggregate . 153)(attribute_reference . 51)(choice_expression . 178)(choice_relation_and_list . 179)(choice_relation_or_list . 180)(choice_relation_xor_list . 181)(choice_relation_and_then_list . 182)(choice_relation_or_else_list . 183)(choice_relation . 184)(discrete_choice . 185)(discrete_choice_list . 1298)(factor . 155)(name . 189)(primary . 159)(qualified_expression . 54)(range . 190)(selected_component . 55)(simple_expression . 464)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      ((variant . 1297))
      nil
      nil
      ...
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 187)(expression_opt . 1293)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      ((identifier_opt . 1291))
      ((identifier_opt . 1290))
      nil
      ...
      nil
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 1288)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      nil
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(expression . 1285)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(raise_expression . 160)(relation_and_list . 161)(relation_and_then_list . 162)(relation_or_list . 163)(relation_or_else_list . 164)(relation_xor_list . 165)(relation . 166)(selected_component . 55)(simple_expression . 167)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      nil
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 1283)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((aggregate . 153)(attribute_reference . 51)(factor . 155)(name . 156)(primary . 159)(qualified_expression . 54)(selected_component . 55)(simple_expression . 1325)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      ((aspect_clause . 1014)(at_clause . 304)(component_declaration . 1015)(component_item . 1016)(component_list . 1017)(component_list_opt . 1323)(enumeration_representation_clause . 311)(identifier_list . 1019)(record_representation_clause . 335)(variant_part . 1020))
      nil
      nil
      ((abstract_subprogram_declaration . 302)(aspect_clause . 303)(at_clause . 304)(body . 305)(body_stub . 306)(declaration . 307)(declarations . 308)(declarative_part_opt . 1320)(entry_declaration . 310)(enumeration_representation_clause . 311)(exception_declaration . 312)(expression_function_declaration . 313)(full_type_declaration . 314)(function_specification . 16)(generic_declaration . 315)(generic_formal_part . 18)(generic_instantiation . 316)(generic_package_declaration . 20)(generic_renaming_declaration . 317)(generic_subprogram_declaration . 22)(identifier_list . 318)(incomplete_type_declaration . 319)(null_procedure_declaration . 320)(object_declaration . 321)(object_renaming_declaration . 322)(overriding_indicator_opt . 323)(package_body . 324)(package_body_stub . 325)(package_declaration . 326)(package_renaming_declaration . 327)(package_specification . 30)(pragma . 328)(private_extension_declaration . 329)(private_type_declaration . 330)(procedure_specification . 32)(proper_body . 331)(protected_body . 332)(protected_body_stub . 333)(protected_type_declaration . 334)(record_representation_clause . 335)(renaming_declaration . 336)(single_protected_declaration . 337)(single_task_declaration . 338)(subprogram_body . 339)(subprogram_body_stub . 340)(subprogram_declaration . 341)(subprogram_renaming_declaration . 342)(subtype_declaration . 343)(task_body . 344)(task_body_stub . 345)(task_type_declaration . 346)(type_declaration . 347)(use_clause . 348))
      ((aggregate . 153)(attribute_reference . 51)(discrete_subtype_definition . 1319)(factor . 155)(name . 891)(primary . 159)(qualified_expression . 54)(range . 769)(selected_component . 55)(simple_expression . 770)(subtype_indication . 771)(term . 168)(term_list . 169)(unary_adding_operator . 170))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((accept_statement . 638)(assignment_statement . 639)(asynchronous_select . 640)(attribute_reference . 51)(block_statement . 641)(case_statement . 642)(conditional_entry_call . 643)(delay_statement . 644)(exit_statement . 645)(extended_return_statement . 646)(handled_sequence_of_statements . 1330)(if_statement . 648)(iteration_scheme . 649)(label_opt . 650)(loop_statement . 651)(name . 652)(pragma . 653)(procedure_call_statement . 654)(qualified_expression . 54)(raise_statement . 655)(requeue_statement . 656)(selected_component . 55)(selective_accept . 657)(select_statement . 658)(sequence_of_statements . 659)(sequence_of_statements_opt . 660)(simple_return_statement . 661)(statement . 662)(timed_entry_call . 663))
