...
(defconst ada-grammar-wy--parse-table
   ...
   '((AMPERSAND BAR BOX COLON COLON_EQUAL COMMA DOT DOT_DOT EQUAL EQUAL_GREATER GREATER GREATER_EQUAL GREATER_GREATER LESS LESS_EQUAL LESS_LESS MINUS PLUS SEMICOLON SLASH SLASH_EQUAL STAR STAR_STAR TICK IDENTIFIER STRING_LITERAL CHARACTER_LITERAL ABS ACCEPT ABORT ABSTRACT ACCESS ALIASED ALL AND ARRAY AT BEGIN BODY CASE CONSTANT DECLARE DELAY DELTA DIGITS DO ELSE ELSIF END ENTRY EXCEPTION EXIT FOR FUNCTION GENERIC GOTO IF IN INTERFACE IS LEFT_PAREN LIMITED LOOP MOD NEW NOT NULL OF OR OTHERS OUT OVERRIDING PACKAGE PRAGMA PRIVATE PROCEDURE PROTECTED RAISE RANGE RECORD REM RENAMES REQUEUE RETURN REVERSE RIGHT_PAREN SEPARATE SELECT SOME SUBTYPE SYNCHRONIZED TAGGED TASK TERMINATE THEN TYPE UNTIL USE WHEN WHILE WITH XOR )
     ...
     [((default . error) (SEPARATE .  10) (USE .  11) (LIMITED .  3) (PRIVATE .  8) (WITH .  12) (PRAGMA .  7) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (PACKAGE .  6) (GENERIC .  2))
      ...
      ((default . error) (FUNCTION . ( 72 (generic_formal_part . 1))) (PROCEDURE . ( 74 (generic_formal_part . 1))) (PACKAGE . ( 73 (generic_formal_part . 1))) (PRAGMA .  7) (WITH .  76) (TYPE .  75) (IDENTIFIER .  71))
      ...
      ((default . error) (BODY .  66) (IDENTIFIER .  47) (CHARACTER_LITERAL .  49) (STRING_LITERAL .  48))
      ((default . error) (IDENTIFIER .  65))
      ((default . error) (WITH .  62) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (PACKAGE .  61) (GENERIC .  60))
      ((default . error) (IDENTIFIER .  47) (CHARACTER_LITERAL .  49) (STRING_LITERAL .  48))
      ((default . error) (LEFT_PAREN .  58))
      ((default . error) (TYPE .  56) (ALL .  55) (IDENTIFIER .  47) (CHARACTER_LITERAL .  49) (STRING_LITERAL .  48))
      ((default . error) (IDENTIFIER .  47) (CHARACTER_LITERAL .  49) (STRING_LITERAL .  48))
      ...
      ((default . error) ($EOI .  45) (SEPARATE .  10) (USE .  11) (LIMITED .  3) (PRIVATE .  8) (WITH .  12) (PRAGMA .  7) (NOT .  4) (OVERRIDING .  5) (FUNCTION . (overriding_indicator_opt . 2)) (PROCEDURE . (overriding_indicator_opt . 2)) (PACKAGE .  6) (GENERIC .  2))
      ...
      ((default . error) (DOT .  86) (SEMICOLON . (name_list . 0)) (COMMA . (name_list . 0)) (TICK .  87) (LEFT_PAREN .  105))
      ...
      ((default . error) (IDENTIFIER .  47) (CHARACTER_LITERAL .  49) (STRING_LITERAL .  48))
      ((default . error) (RENAMES .  106) (DOT .  86) (TICK .  87) (IS . ( 104 (aspect_specification_opt . 0))) (WITH .  107) (LEFT_PAREN .  105))
      ...
      ((default . error) (PACKAGE . (generic_formal_part . 0)) (PROCEDURE . (generic_formal_part . 0)) (FUNCTION . (generic_formal_part . 0)) (PRAGMA .  7) (WITH .  76) (TYPE .  75) (IDENTIFIER .  71))
     ...
     [((compilation_unit . 13)(compilation_unit_list . 14)(context_item . 15)(generic_declaration . 16)(generic_formal_part . 17)(generic_instantiation . 18)(generic_package_declaration . 19)(generic_renaming_declaration . 20)(generic_subprogram_declaration . 21)(library_item . 22)(library_unit_declaration . 23)(library_unit_renaming_declaration . 24)(overriding_indicator_opt . 25)(package_body . 26)(package_declaration . 27)(package_renaming_declaration . 28)(package_specification . 29)(pragma . 30)(procedure_specification . 31)(subprogram_body . 32)(subprogram_declaration . 33)(subprogram_renaming_declaration . 34)(subunit . 35)(use_clause . 36)(with_clause . 37))
      ...
      ((formal_object_declaration . 77)(formal_subprogram_declaration . 78)(formal_type_declaration . 79)(formal_package_declaration . 80)(generic_formal_parameter_declarations . 81)(generic_formal_parameter_declaration . 82)(identifier_list . 83)(pragma . 84))
      nil
      nil
      nil
      ((attribute_reference . 50)(name . 67)(qualified_expression . 53)(selected_component . 54))
      nil
      ((generic_declaration . 16)(generic_formal_part . 17)(generic_instantiation . 18)(generic_package_declaration . 19)(generic_subprogram_declaration . 21)(library_unit_declaration . 63)(overriding_indicator_opt . 64)(package_declaration . 27)(package_specification . 29)(procedure_specification . 31)(subprogram_declaration . 33))
      ...
      nil
      nil
      ((package_specification . 43)(procedure_specification . 31)(subprogram_specification . 44))
      nil
      nil
      nil
      nil
      ...
      nil
      nil
      ((attribute_reference . 50)(name_list . 120)(name . 52)(qualified_expression . 53)(selected_component . 54))
      nil
      ...
      ((formal_object_declaration . 77)(formal_subprogram_declaration . 78)(formal_type_declaration . 79)(formal_package_declaration . 80)(generic_formal_parameter_declarations . 81)(generic_formal_parameter_declaration . 82)(identifier_list . 83)(pragma . 84))
      ((attribute_reference . 50)(name . 114)(qualified_expression . 53)(selected_component . 54))
      ((attribute_reference . 50)(name_list . 113)(name . 52)(qualified_expression . 53)(selected_component . 54))
      nil
      ((procedure_specification . 31)(subprogram_specification . 112))
      nil
      ((attribute_reference . 50)(name . 109)(qualified_expression . 53)(selected_component . 54))
      ((actual_parameter_part . 90)(aspect_specification_opt . 108))
      nil
      nil
      ((attribute_reference . 50)(name_list . 102)(name . 52)(qualified_expression . 53)(selected_component . 54))
      nil
      ((attribute_reference . 50)(name . 101)(qualified_expression . 53)(selected_component . 54))
      ((attribute_reference . 50)(name . 100)(qualified_expression . 53)(selected_component . 54))
      ((attribute_reference . 50)(name . 99)(qualified_expression . 53)(selected_component . 54))
      nil
      ...
      nil
      nil
      ((formal_object_declaration . 77)(formal_subprogram_declaration . 78)(formal_type_declaration . 79)(formal_package_declaration . 80)(generic_formal_parameter_declaration . 95)(identifier_list . 83)(pragma . 84))
      nil
      nil
      nil
      ...
      nil
      ((actual_parameter_part . 90))
      ((attribute_reference . 50)(name . 138)(qualified_expression . 53)(selected_component . 54))
      nil
      nil
      ((attribute_reference . 50)(name_list . 136)(name . 52)(qualified_expression . 53)(selected_component . 54))
      nil
      nil
      nil
      ((actual_parameter_part . 90)(aspect_specification_opt . 108))
